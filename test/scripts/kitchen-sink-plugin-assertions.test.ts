  ...
  try {
    ...
    writeJson(installsPath, {
      installRecords: {
        [pluginId]: {
          installPath,
          resolvedSpec: "@luckynemo/kitchen-sink@latest",
          resolvedVersion: "1.0.0",
          source: "npm",
          spec: "@luckynemo/kitchen-sink@latest",
        },
      },
    });
    ...
    return spawnSync(process.execPath, [ASSERTIONS_SCRIPT, "assert-installed"], {
      ...
      env: {
        ...
        KITCHEN_SINK_SPEC: "npm:@luckynemo/kitchen-sink@latest",
  ...
  try {
    ...
    writeJson(installsPath, {
      installRecords: {
        [pluginId]: {
          ...
          installPath,
          resolvedSpec: "clawhub:@luckynemo/kitchen-sink@latest",
          resolvedVersion: "1.0.0",
          resolvedAt: 1,
          source: "clawhub",
          spec: "clawhub:@luckynemo/kitchen-sink@latest",
          version: "1.0.0",
        },
      },
    });
    ...
    return spawnSync(process.execPath, [ASSERTIONS_SCRIPT, "assert-installed"], {
      ...
      env: {
        ...
        KITCHEN_SINK_SPEC: "clawhub:@luckynemo/kitchen-sink@latest",
      ...
      const result = spawnSync(
        ...
        [ASSERTIONS_SCRIPT, "expect-failure", outputPath],
        {
          ...
          env: {
            ...
            KITCHEN_SINK_SOURCE: "npm",
            KITCHEN_SINK_SPEC: "npm:@luckynemo/kitchen-sink@0.0.0",
          },
        },
      );
...
export KITCHEN_SINK_SPEC=npm:@luckynemo/kitchen-sink@0.0.0
source scripts/e2e/lib/kitchen-sink-plugin/sweep.sh
run_expect_failure "install/failure" bash -c 'printf "%s\\n" "npm ERR! No matching version @luckynemo/kitchen-sink@0.0.0"; exit 1'
