  ...
  it("parses child run IDs and repair flags", () => {
    expect(
      parseReleaseVerifyBetaArgs([
        ...
        "v2026.5.10-beta.3",
        "--plugins",
        "@luckynemo/plugin-a,@luckynemo/plugin-b",
      ...
      pluginSelection: ["@luckynemo/plugin-a", "@luckynemo/plugin-b"],
      clawHubBootstrapPlugins: ["@luckynemo/plugin-b"],
...
describe("validateClawHubBootstrapEvidence", () => {
  ...
  const evidence = {
    ...
    requestedPlugins: ["@luckynemo/meta"],
  ...
  function validate(
    ...
    return validateClawHubBootstrapEvidence({
      ...
      expectedPackages: overrides.expectedPackages ?? ["@luckynemo/meta"],
  ...
  it("rejects legacy release-ref runs and mismatched target/package evidence", () => {
    ...
    expect(() => validate({ expectedPackages: ["@luckynemo/other"] })).toThrow(
