...
describe("ClawHub published artifact verification", () => {
  ...
  it("rejects a missing configure-only tag before artifact or publisher requests", async () => {
    ...
    await expect(
      ...
      "@luckynemo/meta@2026.7.1-beta.3 ClawHub artifact did not stabilize after 1 attempts; last failure @luckynemo/meta ClawHub tag beta mismatch",
    );
