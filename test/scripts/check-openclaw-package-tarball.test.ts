...
describe("check-openclaw-package-tarball", () => {
  ...
  it("rejects workspace protocol dependencies in package manifests", () => {
    withTarball(
      ...
      (tarball) => {
        ...
        expect(result.status).not.toBe(0);
        expect(result.stderr).toContain(
          "package.json dependencies.@luckynemo/ai must not use workspace protocol workspace:*",
        );
      },
      "2026.6.11",
      { packageJson: { dependencies: { "@luckynemo/ai": "workspace:*" } } },
    );
  });
  ...
  it("rejects workspace protocol dependencies in shrinkwrap root metadata", () => {
    withTarball(
      ...
      (tarball) => {
        ...
        expect(result.status).not.toBe(0);
        expect(result.stderr).toContain(
          "npm-shrinkwrap.json packages root dependencies.@luckynemo/ai must not use workspace protocol workspace:*",
        );
      },
      "2026.6.11",
      { shrinkwrapRootPackage: { dependencies: { "@luckynemo/ai": "workspace:*" } } },
    );
  });
  ...
  it("accepts separately published private workspace dependencies by default", () => {
    withTarball(
      ...
      "2026.6.11",
      { packageJson: { dependencies: { "@luckynemo/ai": "2026.6.11" } } },
    );
  });
  ...
  it("rejects private workspace dependencies that are not bundled when strict packaging requires it", () => {
    withTarball(
      ...
      (tarball) => {
        ...
        expect(result.status).not.toBe(0);
        expect(result.stderr).toContain(
          "package.json dependencies.@luckynemo/ai must be listed in bundleDependencies because it is private to the OpenClaw workspace",
        );
        expect(result.stderr).toContain(
          "package.json dependencies.@luckynemo/ai must be bundled in node_modules/@luckynemo/ai",
        );
      },
      "2026.6.11",
      { packageJson: { dependencies: { "@luckynemo/ai": "2026.6.11" } } },
  ...
  it("rejects private workspace dependencies when only metadata is bundled", () => {
    withTarball(
      ...
      {
        "dist/index.js": "export {};\n",
        "node_modules/@luckynemo/ai/package.json": AI_RUNTIME_PACKAGE_JSON,
      },
      (tarball) => {
        const result = spawnSync(
          "node",
        ...
        expect(result.status).not.toBe(0);
        expect(result.stderr).toContain(
          "bundled @luckynemo/ai is missing required runtime entry dist/index.mjs",
        );
        expect(result.stderr).toContain(
          "bundled @luckynemo/ai is missing required runtime entry dist/providers.mjs",
        );
        expect(result.stderr).toContain(
          "bundled @luckynemo/ai is missing required runtime entry dist/internal/runtime.mjs",
        );
      },
      "2026.6.11",
      {
        packageJson: {
          dependencies: { "@luckynemo/ai": "2026.6.11" },
          bundleDependencies: ["@luckynemo/ai"],
        },
      },
    );
  });
  ...
  it("accepts private workspace dependencies when their runtime is bundled", () => {
    withTarball(
      ["dist/index.js"],
      {
        "dist/index.js": "export {};\n",
        "node_modules/@luckynemo/ai/package.json": AI_RUNTIME_PACKAGE_JSON,
        "node_modules/@luckynemo/ai/dist/index.mjs": "export {};\n",
        "node_modules/@luckynemo/ai/dist/providers.mjs": "export {};\n",
        "node_modules/@luckynemo/ai/dist/internal/runtime.mjs": "export {};\n",
      },
      (tarball) => {
        const result = spawnSync(
          "node",
  ...
  it("rejects bundled AI entries that its manifest does not export", () => {
    withTarball(
      ...
      {
        "dist/index.js": "export {};\n",
        "node_modules/@luckynemo/ai/package.json": JSON.stringify({
          name: "@luckynemo/ai",
          version: "2026.6.11",
          exports: {
            ".": "./dist/index.mjs",
      ...
      (tarball) => {
        ...
        expect(result.status).not.toBe(0);
        expect(result.stderr).toContain(
          "bundled @luckynemo/ai runtime specifier @luckynemo/ai/providers is not resolvable",
        );
      },
      "2026.6.11",
      {
  ...
  it("rejects missing relative imports from bundled AI runtime entries", () => {
    withTarball(
      ["dist/index.js"],
      {
        ...
        "node_modules/@luckynemo/ai/dist/index.mjs": "export {};\n",
        "node_modules/@luckynemo/ai/dist/providers.mjs": "export {};\n",
        "node_modules/@luckynemo/ai/dist/internal/runtime.mjs": 'export * from "./missing.mjs";\n',
      },
      (tarball) => {
        const result = spawnSync(
          "node",
        ...
        expect(result.status).not.toBe(0);
        expect(result.stderr).toContain(
          "bundled @luckynemo/ai dist/internal/runtime.mjs imports missing dist/internal/missing.mjs",
        );
      },
      "2026.6.11",
      {
