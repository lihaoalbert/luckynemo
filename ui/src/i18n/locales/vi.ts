...
export const vi: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "Lượt ghé thăm của tôm hùm",
      mascotVisitsOn: "Thỉnh thoảng ghé qua",
      mascotVisitsOff: "Không bao giờ ghé thăm",
      mascotSounds: "Âm thanh tôm hùm",
      mascotSoundsOn: "Tiếng blub nhỏ khi chạm vào",
      mascotSoundsOff: "Im lặng",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "Đã ghé thăm {seen}/{total}",
      mascotdexFirstVisited: "{name} · truy cập lần đầu {date}",
    },
    security: {
      title: "Bảo mật",
      configure: "Cấu hình →",
