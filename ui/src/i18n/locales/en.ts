...
export const en: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "Mascot visits",
      mascotVisitsOn: "Drops by occasionally",
      mascotVisitsOff: "Never visits",
      mascotSounds: "Mascot sounds",
      mascotSoundsOn: "Tiny blubs when touched",
      mascotSoundsOff: "Silent",
      mascotdex: "Mascotdex",
      mascotdexSeen: "{seen}/{total} visited",
      mascotdexFirstVisited: "{name} · first visited {date}",
    },
    security: {
      title: "Security",
      configure: "Configure →",
  ...
  workspaces: {
    ...
    empty: {
      ...
      onboardingCommand: "luckynemo workspaces tabs create --title Main",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Paste the token from luckynemo dashboard --no-open or enter the configured password.",
        stepGenerate:
          "If no token is configured, run luckynemo doctor --generate-gateway-token on the gateway host.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Run luckynemo dashboard --no-open and open the fresh URL or paste its token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Run luckynemo devices list on the Gateway host.",
        stepApproveId: "Approve this request: luckynemo devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Reopen the served dashboard with luckynemo dashboard so the UI and Gateway come from the same install.",
        stepDevUi:
          "If using pnpm ui:dev, rebuild or restart the dev UI against the current checkout.",
        stepRestart:
          "Restart the Gateway after updating LuckyNemo so it serves the current protocol.",
      },
      network: {
        ...
        stepGateway:
          "Confirm the Gateway is running with luckynemo status or luckynemo gateway run.",
        stepUrl:
          "Check the WebSocket URL and use wss:// when the Gateway is behind HTTPS/Tailscale Serve.",
        stepDashboard:
          "Reopen the dashboard with luckynemo dashboard --no-open to recopy the current URL and auth details.",
      },
    },
  },
  chat: {
