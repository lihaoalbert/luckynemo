...
export const pl: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "Wizyty homara",
      mascotVisitsOn: "Wpada od czasu do czasu",
      mascotVisitsOff: "Nigdy nie odwiedza",
      mascotSounds: "Dźwięki homara",
      mascotSoundsOn: "Ciche bulgotanie po dotknięciu",
      mascotSoundsOff: "Cicho",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "Odwiedzono {seen}/{total}",
      mascotdexFirstVisited: "{name} · pierwsza wizyta {date}",
    },
    security: {
