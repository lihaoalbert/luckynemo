...
export const es: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "Visitas de la langosta",
      mascotVisitsOn: "Pasa de vez en cuando",
      mascotVisitsOff: "Nunca visita",
      mascotSounds: "Sonidos de langosta",
      mascotSoundsOn: "Pequeños blubs al tocar",
      mascotSoundsOff: "Silencio",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "{seen}/{total} visitados",
      mascotdexFirstVisited: "{name} · primera visita {date}",
    },
    security: {
      title: "Seguridad",
      configure: "Configurar →",
