...
export const nl: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "Kreeftbezoeken",
      mascotVisitsOn: "Komt af en toe langs",
      mascotVisitsOff: "Komt nooit langs",
      mascotSounds: "Kreeftgeluiden",
      mascotSoundsOn: "Zachte blubjes bij aanraking",
      mascotSoundsOff: "Stil",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "{seen}/{total} bezocht",
      mascotdexFirstVisited: "{name} · voor het eerst bezocht op {date}",
    },
    security: {
      title: "Beveiliging",
      configure: "Configureren →",
