...
export const pt_BR: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "Visitas da lagosta",
      mascotVisitsOn: "Aparece ocasionalmente",
      mascotVisitsOff: "Nunca aparece",
      mascotSounds: "Sons de lagosta",
      mascotSoundsOn: "Pequenos blubs ao tocar",
      mascotSoundsOff: "Silencioso",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "{seen}/{total} visitados",
      mascotdexFirstVisited: "{name} · visitado pela primeira vez em {date}",
    },
    security: {
      title: "Segurança",
      configure: "Configurar →",
