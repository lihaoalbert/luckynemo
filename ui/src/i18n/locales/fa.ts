...
export const fa: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "بازدیدهای خرچنگ",
      mascotVisitsOn: "گاهی سر می‌زند",
      mascotVisitsOff: "هرگز سر نمی‌زند",
      mascotSounds: "صداهای خرچنگ",
      mascotSoundsOn: "حباب‌های ریز هنگام لمس",
      mascotSoundsOff: "بی‌صدا",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "{seen}/{total} بازدیدشده",
      mascotdexFirstVisited: "{name} · نخستین بازدید در {date}",
    },
    security: {
      title: "امنیت",
      configure: "پیکربندی →",
