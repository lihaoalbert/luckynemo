...
export const ar: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "زيارات الكركند",
      mascotVisitsOn: "يزور من حين لآخر",
      mascotVisitsOff: "لا يزور أبدًا",
      mascotSounds: "أصوات الكركند",
      mascotSoundsOn: "فقاعات صغيرة عند اللمس",
      mascotSoundsOff: "صامت",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "تمت زيارة {seen}/{total}",
      mascotdexFirstVisited: "{name} · أول زيارة في {date}",
    },
    security: {
      title: "الأمان",
      configure: "تكوين →",
