...
export const it: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "Visite dell'aragosta",
      mascotVisitsOn: "Passa ogni tanto",
      mascotVisitsOff: "Non passa mai",
      mascotSounds: "Suoni dell'aragosta",
      mascotSoundsOn: "Piccoli blub quando viene toccata",
      mascotSoundsOff: "Silenzioso",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "{seen}/{total} visitati",
      mascotdexFirstVisited: "{name} · prima visita {date}",
    },
    security: {
      title: "Sicurezza",
      configure: "Configura →",
