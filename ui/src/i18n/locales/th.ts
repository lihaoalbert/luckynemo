...
export const th: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "การมาเยือนของกุ้งล็อบสเตอร์",
      mascotVisitsOn: "แวะมาเป็นครั้งคราว",
      mascotVisitsOff: "ไม่เคยมาเยือน",
      mascotSounds: "เสียงกุ้งมังกร",
      mascotSoundsOn: "เสียงบุ๋ง ๆ เบา ๆ เมื่อแตะ",
      mascotSoundsOff: "เงียบ",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "เยี่ยมชมแล้ว {seen}/{total}",
      mascotdexFirstVisited: "{name} · เข้าชมครั้งแรกเมื่อ {date}",
    },
    security: {
      title: "ความปลอดภัย",
      configure: "กำหนดค่า →",
  ...
  chat: {
    ...
    progressLabels: {
      ...
      mascoting: "กำลังตะลุยแบบล็อบสเตอร์",
