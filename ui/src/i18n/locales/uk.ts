...
export const uk: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "Візити омара",
      mascotVisitsOn: "Час від часу заходить",
      mascotVisitsOff: "Ніколи не заходить",
      mascotSounds: "Звуки омара",
      mascotSoundsOn: "Тихі булькання під час дотику",
      mascotSoundsOff: "Без звуку",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "Відвідано {seen}/{total}",
      mascotdexFirstVisited: "{name} · уперше відвідано {date}",
    },
    security: {
      title: "Безпека",
      configure: "Налаштувати →",
