...
export const ja_JP: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "ロブスターの訪問",
      mascotVisitsOn: "ときどき立ち寄る",
      mascotVisitsOff: "訪問しない",
      mascotSounds: "ロブスターのサウンド",
      mascotSoundsOn: "触れると小さなブクブク音",
      mascotSoundsOff: "サイレント",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "{seen}/{total} 訪問済み",
      mascotdexFirstVisited: "{name} · 初回訪問日 {date}",
    },
    security: {
      title: "セキュリティ",
      configure: "設定 →",
