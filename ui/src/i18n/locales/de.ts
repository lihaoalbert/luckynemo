...
export const de: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "Hummerbesuche",
      mascotVisitsOn: "Schaut gelegentlich vorbei",
      mascotVisitsOff: "Besucht nie",
      mascotSounds: "Hummergeräusche",
      mascotSoundsOn: "Leise Blubbergeräusche bei Berührung",
      mascotSoundsOff: "Stumm",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "{seen}/{total} besucht",
      mascotdexFirstVisited: "{name} · zuerst besucht am {date}",
    },
    security: {
      title: "Sicherheit",
      configure: "Konfigurieren →",
