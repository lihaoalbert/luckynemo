...
export const fr: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "Visites du homard",
      mascotVisitsOn: "Passe de temps en temps",
      mascotVisitsOff: "Ne vient jamais",
      mascotSounds: "Sons de homard",
      mascotSoundsOn: "Petits glouglous au toucher",
      mascotSoundsOff: "Silencieux",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "{seen}/{total} visités",
      mascotdexFirstVisited: "{name} · première visite le {date}",
    },
    security: {
      title: "Sécurité",
      configure: "Configurer →",
