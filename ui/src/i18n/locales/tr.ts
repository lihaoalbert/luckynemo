...
export const tr: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "Istakoz ziyaretleri",
      mascotVisitsOn: "Ara sıra uğrar",
      mascotVisitsOff: "Asla ziyaret etmez",
      mascotSounds: "Istakoz sesleri",
      mascotSoundsOn: "Dokunulduğunda küçük blub sesleri",
      mascotSoundsOff: "Sessiz",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "{seen}/{total} ziyaret edildi",
      mascotdexFirstVisited: "{name} · ilk ziyaret {date}",
    },
    security: {
      title: "Güvenlik",
      configure: "Yapılandır →",
