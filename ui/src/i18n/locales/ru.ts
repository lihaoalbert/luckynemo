...
export const ru: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "Визиты омара",
      mascotVisitsOn: "Заглядывает время от времени",
      mascotVisitsOff: "Никогда не заходит",
      mascotSounds: "Звуки омара",
      mascotSoundsOn: "Тихие бульки при касании",
      mascotSoundsOff: "Без уведомлений",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "{seen}/{total} посещено",
      mascotdexFirstVisited: "{name} · первое посещение {date}",
    },
    security: {
      title: "Безопасность",
      configure: "Настроить →",
