...
export const id: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "Kunjungan mascot",
      mascotVisitsOn: "Mampir sesekali",
      mascotVisitsOff: "Tidak pernah berkunjung",
      mascotSounds: "Suara mascot",
      mascotSoundsOn: "Gelembung kecil saat disentuh",
      mascotSoundsOff: "Senyap",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "{seen}/{total} dikunjungi",
      mascotdexFirstVisited: "{name} · pertama kali dikunjungi {date}",
    },
    security: {
      title: "Keamanan",
  ...
  chat: {
    ...
    progressLabels: {
      ...
      mascoting: "Menjelajah bak mascot",
