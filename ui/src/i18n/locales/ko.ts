...
export const ko: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      mascotVisits: "바닷가재 방문",
      mascotVisitsOn: "가끔 들릅니다",
      mascotVisitsOff: "절대 방문하지 않습니다",
      mascotSounds: "바닷가재 소리",
      mascotSoundsOn: "터치하면 작은 뽀글 소리",
      mascotSoundsOff: "무음",
      mascotdex: "Lobsterdex",
      mascotdexSeen: "{seen}/{total} 방문함",
      mascotdexFirstVisited: "{name} · 첫 방문일 {date}",
    },
    security: {
      title: "보안",
      configure: "구성 →",
