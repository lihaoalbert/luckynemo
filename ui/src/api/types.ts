...
export type { FastMode } from "@luckynemo/normalization-core/string-coerce";
...
export type GatewaySessionRow = {
  key: string;
  spawnedBy?: string;
  /** Session working directory (managed worktree path, node cwd, or a plain Gateway-local folder). */
