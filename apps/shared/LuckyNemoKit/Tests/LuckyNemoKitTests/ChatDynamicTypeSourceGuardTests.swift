...
struct ChatDynamicTypeSourceGuardTests {
        ...
        composer: String)
    {
        ...
        return try (
            messageViews: String(
                contentsOf: root.appendingPathComponent("Sources/LuckyNemoChatUI/ChatMessageViews.swift"),
                encoding: .utf8),
            chatView: String(
                contentsOf: root.appendingPathComponent("Sources/LuckyNemoChatUI/ChatView.swift"),
                encoding: .utf8),
            composer: String(
                contentsOf: root.appendingPathComponent("Sources/LuckyNemoChatUI/ChatComposer.swift"),
                encoding: .utf8))
    }
}
