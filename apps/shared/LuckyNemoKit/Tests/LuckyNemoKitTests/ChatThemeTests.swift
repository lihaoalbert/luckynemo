...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = LuckyNemoChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = LuckyNemoChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
