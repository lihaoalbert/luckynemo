...
public struct LuckyNemoChatReplyTarget: Equatable, Sendable {
...
enum ChatReplyQuote {
    ...
    static func prepend(message: String, replyTarget: LuckyNemoChatReplyTarget) -> String {
...
extension LuckyNemoChatViewModel {
    ...
    func setReplyTarget(messageID: UUID, text: String, senderLabel: String) {
        ...
        self.replyTarget = LuckyNemoChatReplyTarget(
            messageID: messageID,
            text: text,
    ...
    func consumeReplyTarget(_ target: LuckyNemoChatReplyTarget?) {
