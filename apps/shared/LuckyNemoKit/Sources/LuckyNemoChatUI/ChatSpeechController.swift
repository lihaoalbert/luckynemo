...
public struct LuckyNemoChatSpeechClip: Equatable, Sendable {
...
public typealias LuckyNemoChatSpeechSynthesis =
    @Sendable (_ text: String) async throws -> LuckyNemoChatSpeechClip
...
@MainActor
@Observable
public final class LuckyNemoChatSpeechController {
    ...
    private let synthesize: LuckyNemoChatSpeechSynthesis
    ...
    public convenience init(synthesize: @escaping LuckyNemoChatSpeechSynthesis) {
        self.init(
    ...
    init(
        synthesize: @escaping LuckyNemoChatSpeechSynthesis,
    ...
    private func run(messageID: UUID, text: String, generation: UInt64) async {
        let clip: LuckyNemoChatSpeechClip? = await {
            do {
