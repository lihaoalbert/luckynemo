...
public struct LuckyNemoChatContextUsage: Equatable, Sendable {
...
enum ChatContextUsageCalculator {
    ...
    static func usage(
        ...
        sessionEntry: LuckyNemoChatSessionEntry?,
        defaults: LuckyNemoChatSessionsDefaults?,
        modelContextWindow: Int?) -> LuckyNemoChatContextUsage?
    {
        ...
        return LuckyNemoChatContextUsage(
    ...
    private static func latestRunTokens(in messages: [LuckyNemoChatMessage]) -> Int? {
    ...
    private static func totalCost(in messages: [LuckyNemoChatMessage]) -> Double? {
...
extension LuckyNemoChatViewModel {
    public var contextUsage: LuckyNemoChatContextUsage? {
    ...
    private func selectedModelContextWindow(sessionEntry: LuckyNemoChatSessionEntry?) -> Int? {
