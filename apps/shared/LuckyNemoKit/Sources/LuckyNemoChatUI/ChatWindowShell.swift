...
/// panel keeps using `LuckyNemoChatView` directly; this shell is the full
/// window experience.
@MainActor
public struct LuckyNemoChatWindowShell: View {
    public nonisolated static let assistantTraceDefaultsKey = "luckynemo.webchat.showAssistantTrace"
    public nonisolated static let assistantReasoningDefaultsKey = "luckynemo.webchat.showAssistantReasoning"
    public nonisolated static let assistantToolActivityDefaultsKey = "luckynemo.webchat.showAssistantToolActivity"
    ...
    private let emptyAssistantPrompts: [LuckyNemoChatView.StarterPrompt]
    ...
    public init(
        ...
        emptyAssistantPrompts: [LuckyNemoChatView.StarterPrompt] = [],
    ...
    private var activeSessionEntry: LuckyNemoChatSessionEntry? {
...
private struct ChatContextUsageMenu: View {
    let usage: LuckyNemoChatContextUsage
    let onCompact: () -> Void

    var body: some View {
        Menu {
            Text(self.tokensLine)
                .font(LuckyNemoChatTypography.body(size: 13, weight: .regular, relativeTo: .body))
