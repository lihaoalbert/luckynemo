...
enum ChatSessionSidebarModel {
    ...
    struct Section: Identifiable, Equatable {
        ...
        var sessions: [LuckyNemoChatSessionEntry] {
    ...
    static func tree(from sessions: [LuckyNemoChatSessionEntry]) -> [Node] {
        ...
        var entriesByKey: [String: LuckyNemoChatSessionEntry] = [:]
        ...
        var childrenByParent: [String: [LuckyNemoChatSessionEntry]] = [:]
        for session in sessions {
        ...
        func build(_ session: LuckyNemoChatSessionEntry, ancestors: Set<String>) -> Node {
    ...
    private static func node(session: LuckyNemoChatSessionEntry, children: [Node]) -> Node {
    ...
    static func displayName(for session: LuckyNemoChatSessionEntry) -> String {
    ...
    private static func visibleSessions(
        ...
        query: String) -> [LuckyNemoChatSessionEntry]
    {
    ...
    private static func placeholder(key: String) -> LuckyNemoChatSessionEntry {
