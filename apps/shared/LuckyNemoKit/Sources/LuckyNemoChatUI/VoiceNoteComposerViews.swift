...
public struct LuckyNemoChatVoiceNoteControl {
    public var recorder: LuckyNemoVoiceNoteRecorder
    public var isTalkActive: Bool

    public init(recorder: LuckyNemoVoiceNoteRecorder, isTalkActive: Bool) {
        self.recorder = recorder
        self.isTalkActive = isTalkActive
    }
}

struct LuckyNemoVoiceNoteButton: View {
    let control: LuckyNemoChatVoiceNoteControl
    let compact: Bool
...
struct LuckyNemoVoiceNoteRecordingRow: View {
    let recorder: LuckyNemoVoiceNoteRecorder
    ...
    var body: some View {
        HStack(spacing: 10) {
            ...
            Text(luckyNemoVoiceNoteDurationLabel(self.recorder.elapsedSeconds))
