...
public struct LuckyNemoChatGatewayRequest: Sendable, Equatable {
...
public enum LuckyNemoChatSessionTargetPolicy: Sendable {
    case preserveBareKeys
    case scopeBareKeysToSelectedAgent
}

public struct LuckyNemoChatSessionTarget: Sendable, Equatable {
    ...
    public static func resolve(
        ...
        policy: LuckyNemoChatSessionTargetPolicy) -> Self
    {
...
public enum LuckyNemoChatGatewayRequests {
    ...
    public static func agentsList(timeoutMs: Double = 15000) -> LuckyNemoChatGatewayRequest {
        LuckyNemoChatGatewayRequest(method: "agents.list", timeoutMs: timeoutMs)
    }

    public static func modelsList() -> LuckyNemoChatGatewayRequest {
        LuckyNemoChatGatewayRequest(method: "models.list", timeoutMs: self.defaultTimeoutMs)
    }

    public static func questionList() -> LuckyNemoChatGatewayRequest {
        LuckyNemoChatGatewayRequest(method: "question.list", timeoutMs: self.defaultTimeoutMs)
    }

    public static func resolveQuestion(
        id: String,
        answers: [String: [String]]) -> LuckyNemoChatGatewayRequest
    {
        let values = answers.mapValues { AnyCodable(["answers": AnyCodable($0)]) }
        return LuckyNemoChatGatewayRequest(
    ...
    public static func sessionsList(
        ...
        timeoutMs: Double = 15000) -> LuckyNemoChatGatewayRequest
    {
    ...
    public static func createSession(
        ...
        worktree: Bool?) -> LuckyNemoChatGatewayRequest
    {
    ...
    public static func abortRun(
        ...
        agentID: String?,
        runID: String,
        requestTimeoutMs: Int = 10000) -> LuckyNemoChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
    ...
    public static func patchSessionPreferences(
        ...
        verboseLevel: String?? = nil) -> LuckyNemoChatGatewayRequest
    {
    ...
    private static func fastModeValue(_ mode: LuckyNemoChatFastMode) -> AnyCodable {
        switch mode {
    ...
    public static func patchSession(
        ...
        pinned: Bool?,
        archived: Bool?,
        unread: Bool?) -> LuckyNemoChatGatewayRequest
    {
        var params = self.sessionParams(sessionKey: sessionKey, agentID: agentID)
        if let label {
    ...
    public static func deleteSession(
        sessionKey: String,
        agentID: String?) -> LuckyNemoChatGatewayRequest
    {
        var params = self.sessionParams(sessionKey: sessionKey, agentID: agentID)
    ...
    public static func compactSession(
        sessionKey: String,
        agentID: String?,
        maxLines: Int? = nil) -> LuckyNemoChatGatewayRequest
    {
        var params = self.sessionParams(sessionKey: sessionKey, agentID: agentID)
        if let maxLines {
    ...
    public static func history(
        ...
        limit: Int? = nil,
        maxChars: Int? = nil,
        timeoutMs: Int? = nil) -> LuckyNemoChatGatewayRequest
    {
    ...
    public static func commandsList(
        sessionKey: String?,
        fallbackAgentID: String?) -> LuckyNemoChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
        ...
        self.add(
            sessionKey.flatMap(LuckyNemoChatSessionKey.agentID) ?? fallbackAgentID,
            to: &params,
            key: "agentId")
        return LuckyNemoChatGatewayRequest(
    ...
    public static func sendMessage(
        ...
        attachments: [LuckyNemoChatAttachmentPayload],
        runTimeoutMs: Int? = nil,
        requestTimeoutMs: Int = 30000) -> LuckyNemoChatGatewayRequest
    {
        var params: [String: AnyCodable] = [
            "sessionKey": AnyCodable(sessionKey),
    ...
    public static func agentWait(
        runID: String,
        timeoutMs: Int,
        requestGraceMs: Int = 5000) -> LuckyNemoChatGatewayRequest
    {
        LuckyNemoChatGatewayRequest(
            method: "agent.wait",
            params: [
    ...
    public static func health(timeoutMs: Int) -> LuckyNemoChatGatewayRequest {
        LuckyNemoChatGatewayRequest(
            method: "health",
...
extension GatewayNodeSession {
    public func request(
        _ request: LuckyNemoChatGatewayRequest,
