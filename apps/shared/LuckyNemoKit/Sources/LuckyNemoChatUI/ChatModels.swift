...
public typealias LuckyNemoPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias LuckyNemoPlatformImage = UIImage
#endif

public enum LuckyNemoChatCommandFilter: String, CaseIterable, Sendable {
    case all = "All"
    case commands = "Commands"
    case skills = "Skills"
}

public struct LuckyNemoChatCommandChoice: Identifiable, Hashable, Sendable {
...
public struct LuckyNemoChatUsageCost: Codable, Hashable, Sendable {
...
public struct LuckyNemoChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: LuckyNemoChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(LuckyNemoChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct LuckyNemoChatMessageContent: Codable, Hashable, Sendable {
    ...
    public let preview: LuckyNemoChatCanvasPreview?
    ...
    public init(
        ...
        content: AnyCodable?,
        preview: LuckyNemoChatCanvasPreview? = nil,
        id: String? = nil,
        name: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.preview = try container.decodeIfPresent(LuckyNemoChatCanvasPreview.self, forKey: .preview)
...
public struct LuckyNemoChatCanvasPreview: Codable, Hashable, Sendable {
    ...
    public var inlineWidgetPath: String? {
        guard self.kind == "canvas",
              ...
              LuckyNemoChatWidgetURLResolver.supportsTarget(url)
        else { return nil }
        return url
    }
...
public struct LuckyNemoChatMessage: Codable, Hashable, Identifiable, Sendable {
    private struct LuckyNemoMetadata: Codable {
        let id: String?
    ...
    public let content: [LuckyNemoChatMessageContent]
    public let timestamp: Double?
    public let idempotencyKey: String?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: LuckyNemoChatUsage?
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedLuckyNemo = try container.decodeIfPresent(LuckyNemoMetadata.self, forKey: .luckyNemo)
        let decodedIdempotencyKey = try decodedLuckyNemo?.idempotencyKey ??
        ...
        let decodedUsage = try container.decodeIfPresent(LuckyNemoChatUsage.self, forKey: .usage)
        ...
        self.transcriptMessageID = decodedLuckyNemo?.id
        ...
        let decodedContent: [LuckyNemoChatMessageContent] = if let decoded = try? container.decode(
            [LuckyNemoChatMessageContent].self,
            forKey: .content)
        {
            decoded
        ...
        let audioAttachments: [LuckyNemoChatMessageContent] = alreadyContainsAudio ? [] : mediaPaths
            .enumerated()
            .compactMap { index, mediaPath in
                ...
                return LuckyNemoChatMessageContent(
                    type: "file",
                    text: nil,
                    mimeType: mimeType,
        ...
        self.isTruncated = decodedLuckyNemo?.truncated == true || decodedContent.contains { content in
...
public struct LuckyNemoChatInFlightRun: Codable, Sendable {
    public let runId: String
    public let text: String
    public let plan: LuckyNemoChatPlanSnapshot?

    // periphery:ignore - package tests construct history fixtures; app consumers decode this payload.
    public init(runId: String, text: String, plan: LuckyNemoChatPlanSnapshot? = nil) {
        self.runId = runId
        self.text = text
        self.plan = plan
    }
...
public struct LuckyNemoChatPlanSnapshot: Codable, Sendable {
    public let steps: [LuckyNemoChatPlanStep]
    public let explanation: String?

    // periphery:ignore - package tests construct history fixtures; app consumers decode this payload.
    public init(steps: [LuckyNemoChatPlanStep], explanation: String? = nil) {
        self.steps = steps
        self.explanation = explanation
    }
}

public struct LuckyNemoChatSessionInfo: Codable, Sendable {
...
public struct LuckyNemoChatHistoryPayload: Codable, Sendable {
    public let sessionKey: String
    public let sessionId: String?
    public let messages: [AnyCodable]?
    public let thinkingLevel: String?
    public let sessionInfo: LuckyNemoChatSessionInfo?
    public let inFlightRun: LuckyNemoChatInFlightRun?
    ...
    public init(
        ...
        sessionInfo: LuckyNemoChatSessionInfo? = nil,
        inFlightRun: LuckyNemoChatInFlightRun? = nil)
    {
...
public struct LuckyNemoSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct LuckyNemoSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [LuckyNemoSessionPreviewItem]
}

public struct LuckyNemoSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [LuckyNemoSessionPreviewEntry]

    public init(ts: Int, previews: [LuckyNemoSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct LuckyNemoChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct LuckyNemoChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct LuckyNemoChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct LuckyNemoSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: LuckyNemoChatMessage?
...
public struct LuckyNemoAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct LuckyNemoChatPlanStep: Codable, Hashable, Sendable {
...
public struct LuckyNemoChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct LuckyNemoGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct LuckyNemoPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: LuckyNemoPlatformImage?
    public let durationSeconds: Double?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: LuckyNemoPlatformImage?,
        durationSeconds: Double? = nil)
    {
        self.url = url
        self.data = data
...
public struct LuckyNemoChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
