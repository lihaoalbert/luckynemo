...
public enum ChatTranscriptExporter {
    ...
    public static func markdown(
        sessionTitle: String?,
        sessionKey: String,
        messages: [LuckyNemoChatMessage]) -> String
    {
    ...
    private static func shouldExport(_ message: LuckyNemoChatMessage) -> Bool {
    ...
    private static func body(for message: LuckyNemoChatMessage) -> String {
        var parts: [String] = []
        let text = self.visibleText(in: message)
        if !text.isEmpty {
            parts.append(text)
    ...
    private static func visibleText(in message: LuckyNemoChatMessage) -> String {
        ChatMessageVisibleText.visibleText(in: message)
    }

    private static func attachments(in message: LuckyNemoChatMessage) -> [LuckyNemoChatMessageContent] {
