...
public protocol LuckyNemoChatTranscriptCache: Sendable {
    func loadSessions() async -> [LuckyNemoChatSessionEntry]
    func loadTranscript(sessionKey: String) async -> [LuckyNemoChatMessage]
    func loadTranscript(sessionKey: String, agentID: String?) async -> [LuckyNemoChatMessage]
    func storeSessions(_ sessions: [LuckyNemoChatSessionEntry]) async
    func storeTranscript(sessionKey: String, messages: [LuckyNemoChatMessage]) async
    func storeTranscript(sessionKey: String, agentID: String?, messages: [LuckyNemoChatMessage]) async
...
extension LuckyNemoChatTranscriptCache {
...
protocol LuckyNemoChatCanonicalTranscriptMerging: LuckyNemoChatTranscriptCache {
...
public struct LuckyNemoChatOutboxAttachment: Codable, Hashable, Sendable {
...
public struct LuckyNemoChatOutboxCommand: Hashable, Sendable, Identifiable {
    ...
    public let attachments: [LuckyNemoChatOutboxAttachment]
...
public enum LuckyNemoChatOutboxUpdateResult: Equatable, Sendable {
    case updated
    case confirmed
    case missing
    case unavailable
...
public enum LuckyNemoChatOutboxChange: Equatable, Sendable {
...
public protocol LuckyNemoChatCommandOutbox: Sendable {
    ...
    func changes() -> AsyncStream<LuckyNemoChatOutboxChange>
}

public struct LuckyNemoChatSessionRoutingIdentity: Equatable, Sendable {
    ...
    public init?(contract: String?) {
        guard let components = LuckyNemoChatSessionRoutingContract.parse(contract) else { return nil }
    ...
    public init?(scope: String?, mainSessionKey: String?, defaultAgentID: String?) {
        guard let contract = LuckyNemoChatSessionRoutingContract.make(
            scope: scope,
