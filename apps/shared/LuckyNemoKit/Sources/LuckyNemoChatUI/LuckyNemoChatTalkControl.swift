public struct LuckyNemoChatAudioInputDevice: Equatable, Identifiable, Sendable {
...
public struct LuckyNemoChatTalkControl {
    ...
    public var inputDevices: [LuckyNemoChatAudioInputDevice]
    ...
    public init(
        ...
        inputDevices: [LuckyNemoChatAudioInputDevice] = [],
