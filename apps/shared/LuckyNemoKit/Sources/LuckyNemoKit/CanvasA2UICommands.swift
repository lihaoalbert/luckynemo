...
public enum LuckyNemoCanvasA2UICommand: String, Codable, Sendable {
...
public struct LuckyNemoCanvasA2UIPushParams: Codable, Sendable, Equatable {
    public var messages: [AnyCodable]
}

public struct LuckyNemoCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
