...
public enum LuckyNemoWatchCommand: String, Codable, Sendable {
    case status = "watch.status"
    case notify = "watch.notify"
}

public enum LuckyNemoWatchPayloadType: String, Codable, Sendable, Equatable {
    case notify = "watch.notify"
...
public enum LuckyNemoWatchRisk: String, Codable, Sendable, Equatable {
    case low
    case medium
    case high
}

public enum LuckyNemoWatchExecApprovalDecision: String, Codable, Sendable, Equatable {
    case allowOnce = "allow-once"
    case deny
}

public enum LuckyNemoWatchExecApprovalCloseReason: String, Codable, Sendable, Equatable {
    case expired
...
public struct LuckyNemoWatchAction: Codable, Sendable, Equatable, Identifiable {
...
public struct LuckyNemoWatchExecApprovalItem: Codable, Sendable, Equatable, Identifiable {
    public var id: String
    ...
    public var allowedDecisions: [LuckyNemoWatchExecApprovalDecision]
    public var risk: LuckyNemoWatchRisk?
    ...
    public init(
        ...
        allowedDecisions: [LuckyNemoWatchExecApprovalDecision] = [],
        risk: LuckyNemoWatchRisk? = nil)
    {
        self.id = id
...
public struct LuckyNemoWatchExecApprovalPromptMessage: Codable, Sendable, Equatable {
    public var type: LuckyNemoWatchPayloadType
    public var approval: LuckyNemoWatchExecApprovalItem
    public var sentAtMs: Int64?
    public var resetResolutionAttemptId: String?

    public init(
        approval: LuckyNemoWatchExecApprovalItem,
        sentAtMs: Int64? = nil,
...
public struct LuckyNemoWatchExecApprovalResolveMessage: Codable, Sendable, Equatable {
    public var type: LuckyNemoWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var decision: LuckyNemoWatchExecApprovalDecision
    ...
    public init(
        approvalId: String,
        gatewayStableID: String? = nil,
        decision: LuckyNemoWatchExecApprovalDecision,
        replyId: String,
        sentAtMs: Int64? = nil)
    {
...
public enum LuckyNemoWatchExecApprovalOutcome: String, Codable, Sendable, Equatable {
    case allowedOnce
    case allowedAlways
    case denied
}

public struct LuckyNemoWatchExecApprovalResolvedMessage: Codable, Sendable, Equatable {
    public var type: LuckyNemoWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var decision: LuckyNemoWatchExecApprovalDecision?
    public var outcome: LuckyNemoWatchExecApprovalOutcome?
    ...
    public init(
        approvalId: String,
        gatewayStableID: String? = nil,
        decision: LuckyNemoWatchExecApprovalDecision? = nil,
        outcome: LuckyNemoWatchExecApprovalOutcome? = nil,
...
public struct LuckyNemoWatchExecApprovalExpiredMessage: Codable, Sendable, Equatable {
    public var type: LuckyNemoWatchPayloadType
    public var approvalId: String
    public var gatewayStableID: String?
    public var reason: LuckyNemoWatchExecApprovalCloseReason
    public var expiredAtMs: Int64?

    public init(
        approvalId: String,
        gatewayStableID: String? = nil,
        reason: LuckyNemoWatchExecApprovalCloseReason,
...
public struct LuckyNemoWatchExecApprovalSnapshotMessage: Codable, Sendable, Equatable {
    public var type: LuckyNemoWatchPayloadType
    public var approvals: [LuckyNemoWatchExecApprovalItem]
    public var gatewayStableID: String?
    public var sentAtMs: Int64?
    ...
    public init(
        approvals: [LuckyNemoWatchExecApprovalItem],
        gatewayStableID: String? = nil,
        sentAtMs: Int64? = nil,
...
public struct LuckyNemoWatchExecApprovalSnapshotRequestItem: Codable, Sendable, Equatable {
    public var approvalId: String
...
public struct LuckyNemoWatchExecApprovalSnapshotRequestMessage: Codable, Sendable, Equatable {
    public var type: LuckyNemoWatchPayloadType
    public var requestId: String
    public var sentAtMs: Int64?
    public var gatewayStableID: String?
    public var heldApprovals: [LuckyNemoWatchExecApprovalSnapshotRequestItem]

    public init(
        requestId: String,
        sentAtMs: Int64? = nil,
        gatewayStableID: String? = nil,
        heldApprovals: [LuckyNemoWatchExecApprovalSnapshotRequestItem] = [])
    {
...
public struct LuckyNemoWatchChatItem: Codable, Sendable, Equatable, Identifiable {
    public var id: String
...
public struct LuckyNemoWatchChatCompletionMessage: Codable, Sendable, Equatable {
    public var type: LuckyNemoWatchPayloadType
...
public enum LuckyNemoWatchAppStatusCode: String, Codable, Sendable, Equatable {
...
public struct LuckyNemoWatchAppStatus: Codable, Sendable, Equatable {
    public var code: LuckyNemoWatchAppStatusCode
    public var localizationKey: String?
    public var arguments: [String]
    public var verbatim: String?

    public init(
        code: LuckyNemoWatchAppStatusCode,
...
public struct LuckyNemoWatchAppSnapshotMessage: Codable, Sendable, Equatable {
    public var type: LuckyNemoWatchPayloadType
    public var gatewayStatus: LuckyNemoWatchAppStatus
    ...
    public var gatewayStableID: String?
    public var talkStatus: LuckyNemoWatchAppStatus
    ...
    public var chatItems: [LuckyNemoWatchChatItem]?
    public var chatStatus: LuckyNemoWatchAppStatus?
    public var chatStatusText: String?
    public var sentAtMs: Int64?
    public var snapshotId: String?

    public init(
        gatewayStatus: LuckyNemoWatchAppStatus,
        ...
        sessionKey: String,
        gatewayStableID: String? = nil,
        talkStatus: LuckyNemoWatchAppStatus,
        talkStatusText: String,
        talkEnabled: Bool,
        talkListening: Bool,
        talkSpeaking: Bool,
        pendingApprovalCount: Int,
        chatItems: [LuckyNemoWatchChatItem]? = nil,
        chatStatus: LuckyNemoWatchAppStatus? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(LuckyNemoWatchPayloadType.self, forKey: .type)
        ...
        self.chatItems = try container.decodeIfPresent([LuckyNemoWatchChatItem].self, forKey: .chatItems)
        ...
        {
            self.gatewayStatus = LuckyNemoWatchAppStatus(
                code: .legacy,
        ...
        {
            self.talkStatus = LuckyNemoWatchAppStatus(
                code: .legacy,
    ...
    private static func decodeLegacyGatewayStatus(
        text: String?,
        connected: Bool) -> LuckyNemoWatchAppStatus
    {
        if connected {
            return LuckyNemoWatchAppStatus(code: .gatewayConnected)
        }
        guard let text, !text.isEmpty else {
            return LuckyNemoWatchAppStatus(code: .gatewayOffline)
        }
        return LuckyNemoWatchAppStatus(code: .legacy, verbatim: text)
    }
    ...
    private static func decodeLegacyTalkStatus(
        ...
        enabled: Bool,
        listening: Bool,
        speaking: Bool) -> LuckyNemoWatchAppStatus
    {
        if speaking {
            return LuckyNemoWatchAppStatus(code: .talkSpeaking)
        }
        if listening {
            return LuckyNemoWatchAppStatus(code: .talkListening)
        }
        if !enabled {
            return LuckyNemoWatchAppStatus(code: .talkOff)
        }
        guard let text, !text.isEmpty else {
            return LuckyNemoWatchAppStatus(code: .talkReady)
        }
        return LuckyNemoWatchAppStatus(code: .legacy, verbatim: text)
    }
    ...
    private static func decodeLegacyChatStatus(
        code: String?,
        text: String?) -> LuckyNemoWatchAppStatus?
    {
        let statusCode: LuckyNemoWatchAppStatusCode? = switch code {
        case "connectIPhone":
            LuckyNemoWatchAppStatusCode.chatConnectIPhone
        case "noMessages":
            LuckyNemoWatchAppStatusCode.chatNoMessages
        case "unavailable":
            LuckyNemoWatchAppStatusCode.chatUnavailable
        default:
            nil
        }
        if let statusCode {
            return LuckyNemoWatchAppStatus(code: statusCode)
        }
        guard let text, !text.isEmpty else { return nil }
        return LuckyNemoWatchAppStatus(code: .legacy, verbatim: text)
    }

    private static func legacyText(for status: LuckyNemoWatchAppStatus) -> String {
    ...
    private static func legacyGatewayText(for code: LuckyNemoWatchAppStatusCode) -> String {
        switch code {
    ...
    private static func legacyTalkText(for code: LuckyNemoWatchAppStatusCode) -> String {
        switch code {
        case .talkOff: "Off"
    ...
    private static func legacyChatText(for code: LuckyNemoWatchAppStatusCode) -> String {
        switch code {
...
public struct LuckyNemoWatchAppSnapshotRequestMessage: Codable, Sendable, Equatable {
    public var type: LuckyNemoWatchPayloadType
    public var requestId: String
    public var sentAtMs: Int64?
...
public enum LuckyNemoWatchAppCommand: String, Codable, Sendable, Equatable {
    case refresh
...
public struct LuckyNemoWatchAppCommandMessage: Codable, Sendable, Equatable {
    public var type: LuckyNemoWatchPayloadType
    public var command: LuckyNemoWatchAppCommand
    public var commandId: String
    public var sessionKey: String?
    public var gatewayStableID: String?
    public var text: String?
    ...
    public init(
        command: LuckyNemoWatchAppCommand,
        commandId: String,
...
public struct LuckyNemoWatchStatusPayload: Codable, Sendable, Equatable {
...
public struct LuckyNemoWatchNotifyParams: Codable, Sendable, Equatable {
    ...
    public var expiresAtMs: Int64?
    public var risk: LuckyNemoWatchRisk?
    public var actions: [LuckyNemoWatchAction]?
    ...
    public init(
        ...
        expiresAtMs: Int64? = nil,
        risk: LuckyNemoWatchRisk? = nil,
        actions: [LuckyNemoWatchAction]? = nil)
    {
        self.title = title
        self.body = body
...
public struct LuckyNemoWatchNotifyPayload: Codable, Sendable, Equatable {
