...
public struct ArtifactBuildInfo: Equatable, Sendable {
        ...
        versionKeys: [String] = ["CFBundleShortVersionString"])
    {
        ...
        self.gitCommit = Self.validGitCommit(Self.nonEmptyString(infoDictionary["LuckyNemoGitCommit"]))
        let buildTimestamp = Self.nonEmptyString(infoDictionary["LuckyNemoBuildTimestamp"])
