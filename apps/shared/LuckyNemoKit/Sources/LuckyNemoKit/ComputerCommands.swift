...
public enum LuckyNemoComputerCommand: String, Codable, Sendable {
...
public enum LuckyNemoComputerAction: String, Codable, Sendable {
...
public enum LuckyNemoComputerScrollDirection: String, Codable, Sendable {
    case up
    case down
    case left
    case right
...
public struct LuckyNemoComputerActParams: Codable, Sendable, Equatable {
    public var action: LuckyNemoComputerAction
    ...
    public var scrollDirection: LuckyNemoComputerScrollDirection?
    ...
    public init(
        ...
        scrollDirection: LuckyNemoComputerScrollDirection? = nil,
...
public struct LuckyNemoComputerActResult: Codable, Sendable, Equatable {
    public var ok: Bool
