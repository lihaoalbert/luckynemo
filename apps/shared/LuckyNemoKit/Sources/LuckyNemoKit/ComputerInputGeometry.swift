...
public struct LuckyNemoComputerDisplayGeometry: Sendable, Equatable {
...
public enum LuckyNemoComputerInputGeometry {
    ...
    public static func displayFrameId(
        ...
        sourceHeight: Double,
        referenceWidth: Int,
        display: LuckyNemoComputerDisplayGeometry) -> String
    {
        let descriptor = [
            String(displayID),
    ...
    public static func isValidMappingGeometry(
        sourceWidth: Double,
        sourceHeight: Double,
        display: LuckyNemoComputerDisplayGeometry) -> Bool
    {
    ...
    public static func mapReferencePointToGlobal(
        ...
        display: LuckyNemoComputerDisplayGeometry) -> (x: Double, y: Double)
    {
