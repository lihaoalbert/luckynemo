...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int64,
        nonce: String) -> [String: LuckyNemoProtocol.AnyCodable]?
    {
        ...
        return [
            "id": LuckyNemoProtocol.AnyCodable(identity.deviceId),
            "publicKey": LuckyNemoProtocol.AnyCodable(publicKey),
            "signature": LuckyNemoProtocol.AnyCodable(signature),
            "signedAt": LuckyNemoProtocol.AnyCodable(signedAtMs),
            "nonce": LuckyNemoProtocol.AnyCodable(nonce),
        ]
    }
}
