...
public struct SkillStatusConfigCheck: Codable, Identifiable, Sendable {
    ...
    public let value: LuckyNemoProtocol.AnyCodable?
    ...
    public init(path: String, value: LuckyNemoProtocol.AnyCodable?, satisfied: Bool) {
        self.path = path
        self.value = value
...
public struct SkillUpdateResult: Codable, Sendable {
    public let ok: Bool
    public let skillKey: String
    public let config: [String: LuckyNemoProtocol.AnyCodable]?
}
