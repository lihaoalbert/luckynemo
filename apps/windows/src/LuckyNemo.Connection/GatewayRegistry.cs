...
public sealed class GatewayRegistry
{
    ...
    /// </summary>
    /// <param name="dataDir">Root data directory (e.g. %APPDATA%/LuckyNemoTray).</param>
    ...
    public GatewayRegistry(string dataDir, IFileSystem? fs = null, ILuckyNemoLogger? logger = null)
    {
