...
public sealed record GatewayConnectionSnapshot
{
    ...
    public LuckyNemo.Shared.PairingStatus NodePairingStatus { get; init; }
    ...
    public LuckyNemo.Shared.PairingApprovalKind NodePairingApprovalKind { get; init; }
    ...
    public static GatewayConnectionSnapshot Idle { get; } = new()
    {
        ...
        NodePairingStatus = LuckyNemo.Shared.PairingStatus.Unknown
    };
