...
public sealed partial class VoiceOverlayWindow : WindowEx
{
    ...
    public VoiceOverlayWindow(VoiceService voiceService, ILuckyNemoLogger logger, bool testOnly = false)
    {
        InitializeComponent();
    ...
    private void OnUtteranceCompleted(LuckyNemo.Shared.Audio.UtteranceResult utterance)
    {
