...
public sealed partial class TrayMenuWindow : WindowEx
{
    ...
    private TrayMenuWindow(TrayMenuWindow? ownerMenu)
    {
        ...
        InitializeComponent();
        Title = AppIdentity.DecorateWindowTitle("LuckyNemo Menu");
    ...
    {
        if (Environment.GetEnvironmentVariable("LUCKYNEMO_UI_AUTOMATION") == "1")
            return;
    ...
    public void ShowAtCursor()
    {
        ...
        if (GetCursorPos(out POINT pt))
        {
            ...
            var (x, y) = LuckyNemo.Shared.MenuPositioner.CalculatePosition(
                pt.X, pt.Y,
