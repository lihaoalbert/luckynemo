...
internal static class NodeCapabilityGating
{
    ...
    /// <see cref="LuckyNemo.Shared.GatewayNodeInfo"/> array — the single source
    ...
    public static System.Collections.Generic.IReadOnlyList<string>? GetLocalNodeCapabilities(
        LuckyNemo.Shared.GatewayNodeInfo[]? nodes, string? localDeviceId)
    ...
    /// </summary>
    public static LuckyNemo.Shared.GatewayNodeInfo? GetLocalNodeInfo(
        LuckyNemo.Shared.GatewayNodeInfo[]? nodes, string? localDeviceId)
    {
