...
{
    public static AppNotification FromGatewayNotification(LuckyNemoNotification notification, string? chatActionLabel = null)
    {
    ...
    private static string NormalizeTitle(string? title) =>
        string.IsNullOrWhiteSpace(title) ? "LuckyNemo" : title.Trim();
