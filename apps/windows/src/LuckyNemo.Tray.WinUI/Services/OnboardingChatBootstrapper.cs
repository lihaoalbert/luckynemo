...
public static class OnboardingChatBootstrapper
{
    ...
    public const string Message =
        "Hi! I just installed LuckyNemo and you're my brand-new agent. " +
        ...
        TimeSpan? existingWorkspaceProbeTimeout = null)
    {
        ...
        // LuckyNemo state that the bootstrap ritual would otherwise rewrite.
                ...
                settings.SettingsDirectory))
        {
            ...
            if (workspaceState == ExistingWorkspaceState.Existing)
            {
                ...
                Logger.Info("[OnboardingChatBootstrapper] Existing LuckyNemo workspace state detected; skipping first-run bootstrap prompt.");
                return true;
            }
