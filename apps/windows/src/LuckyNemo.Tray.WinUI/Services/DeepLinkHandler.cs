...
public static class DeepLinkHandler
{
    ...
    public static void RegisterUriScheme()
    {
        ...
        try
        {
            ...
            key?.SetValue("", "URL:LuckyNemo Protocol");
...
#else
    private static bool IsPackagedApp() => LuckyNemoTray.Helpers.PackageHelper.IsPackaged;
#endif

    public static void Handle(string uri, DeepLinkActions actions)
    {
        var result = LuckyNemo.Shared.DeepLinkParser.ParseDeepLink(uri, AppIdentity.ProtocolScheme);
        if (result == null)
            return;
