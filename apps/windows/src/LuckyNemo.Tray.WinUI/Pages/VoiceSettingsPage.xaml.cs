...
public sealed partial class VoiceSettingsPage : Page
{
    ...
    private void UpdateModelStatus()
    {
        ...
        // accurate status.
        var manager = new LuckyNemo.Shared.Audio.WhisperModelManager(
    ...
    private void PopulatePiperVoices(SettingsManager settings)
    {
        ...
        foreach (var v in LuckyNemo.Shared.Audio.PiperVoiceManager.AvailableVoices)
        {
    ...
    private void UpdatePiperVoiceState()
    {
        ...
        var voices = new LuckyNemo.Shared.Audio.PiperVoiceManager(SettingsManager.SettingsDirectoryPath, new AppLogger());
    ...
    private async Task OnPiperPreviewClickAsync()
    {
        ...
        try
        {
            ...
            await tts.SpeakAsync(new LuckyNemo.Shared.Capabilities.TtsSpeakArgs
            {
                Text = L("VoiceSettingsPage_CompanionPreviewText"),
                Provider = LuckyNemo.Shared.Capabilities.TtsCapability.PiperProvider,
                VoiceId = voiceId,
                Interrupt = true
            });
        }
