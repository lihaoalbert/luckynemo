...
public sealed partial class ConnectionPage : Page
{
    ...
    private WslGatewayController WslGatewayController =>
        _wslGatewayController ??= new WslGatewayController(
            new WslExeCommandRunner(new LuckyNemoTray.AppLogger()),
    ...
    private void ApplyRecoveryBody(ConnectionPagePlan plan)
    {
        ...
        var bullets = plan.Recovery switch
        {
            ...
            RecoveryCategory.Tailscale => new[]
            {
                ...
                "Open the managed WSL gateway terminal as root and check tailscaled, Tailscale Serve, and the LuckyNemo gateway service. Funnel is unsupported; remove any Funnel route. Companion keeps using WSS and never falls back to localhost.",
            },
            _ => new[]
            {
