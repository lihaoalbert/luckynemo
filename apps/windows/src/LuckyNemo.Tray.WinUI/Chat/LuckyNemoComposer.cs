...
using CoreMenuFlyoutItemBase = LuckyNemoTray.FunctionalUI.Core.MenuFlyoutItemBase;
...
/// </summary>
public record LuckyNemoComposerProps(
...
public sealed class LuckyNemoComposer : Component<LuckyNemoComposerProps>
{
    ...
    public override Element Render()
    {
        ...
        Action startVoiceRecording = () =>
        {
            ...
            _ = Task.Run(async () =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    LuckyNemoTray.Services.Logger.Debug($"LuckyNemoComposer: voice transcription failed/cancelled: {ex.Message}");
                }
                finally
                {
                ...
                if (!pasteHookedRef.Current)
                {
                    ...
                    tb.Paste += async (s, e) =>
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            LuckyNemoTray.Services.Logger.Debug($"LuckyNemoComposer: clipboard image paste failed, falling back to text: {ex.Message}");
                        }
                    };
                }
            })
        ...
        // in chronological order. See LuckyNemoChatTimeline.RenderPermissionEntry.
