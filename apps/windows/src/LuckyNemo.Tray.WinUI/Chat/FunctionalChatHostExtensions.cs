...
/// <summary>
/// Helper for hosting the <see cref="LuckyNemoChatRoot"/> FunctionalUI tree
...
public static class FunctionalChatHostExtensions
{
    ...
    /// <see cref="LuckyNemoChatDataProvider"/>'s <c>post</c> argument from
    ...
    /// <summary>
    /// Mount <see cref="LuckyNemoChatRoot"/> into <paramref name="target"/>.
        ...
        bool suppressAutoDispose = false)
    {
        ...
        var root = new LuckyNemoChatRoot(
            provider,
            initialThreadId,
            onReadAloud,
            onStopSpeaking,
...
/// </summary>
public sealed class MountedFunctionalChat(Border target, FunctionalHostControl host, LuckyNemoChatRoot root) : IDisposable
{
    public LuckyNemoChatRoot ChatRoot => root;
