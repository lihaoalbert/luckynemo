...
/// <summary>
/// Subset of <see cref="LuckyNemoGatewayClient"/> needed by
/// <see cref="LuckyNemoChatDataProvider"/>. Exposed as an interface so the
...
/// <summary>
/// Production bridge wrapping a real <see cref="LuckyNemoGatewayClient"/>.
/// </summary>
public sealed class GatewayClientChatBridge : IChatGatewayBridge
{
    ...
    public GatewayClientChatBridge(LuckyNemoGatewayClient client)
    {
        _client = client;
