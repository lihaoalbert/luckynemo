...
internal static class AppIdentity
{
    ...
    public const string DisplayName = "LuckyNemo Companion (Dev)";

    /// <summary>Short name used in tray tooltip prefix.</summary>
    public const string TrayName = "LuckyNemo Tray (Dev)";

    /// <summary>MSIX package identity name (must differ from release for side-by-side).</summary>
    public const string PackageIdentityName = "LuckyNemo.Companion.Dev";
    ...
    public const string AutoStartRegistryName = "LuckyNemoTray-Dev";

    /// <summary>Windows scheduled task name (must differ so both can auto-start).</summary>
    public const string StartupTaskName = "LuckyNemo Companion (Dev)";

    /// <summary>Leaf directory for local and roaming app-owned data.</summary>
    public const string DataDirectoryName = "LuckyNemoTray-Dev";

    /// <summary>Single-instance mutex base name.</summary>
    public const string MutexBaseName = "LuckyNemoTray-Dev";

    /// <summary>Protocol scheme for deep links.</summary>
    public const string ProtocolScheme = "luckynemo-dev";

    /// <summary>App-owned WSL distro used by embedded setup.</summary>
    public const string SetupDistroName = "LuckyNemoGateway-Dev";
...
#else
    /// <summary>Human-visible app name shown in tray tooltips, window titles, and notifications.</summary>
    public const string DisplayName = "LuckyNemo Companion";

    /// <summary>Short name used in tray tooltip prefix.</summary>
    public const string TrayName = "LuckyNemo Tray";

    /// <summary>MSIX package identity name.</summary>
    public const string PackageIdentityName = "LuckyNemo.Companion";

    /// <summary>Win32 AppUserModelID used for notifications and shell grouping.</summary>
    public const string AppUserModelId = PackageIdentityName;

    /// <summary>Windows Registry auto-start value name.</summary>
    public const string AutoStartRegistryName = "LuckyNemoTray";

    /// <summary>Windows scheduled task name.</summary>
    public const string StartupTaskName = "LuckyNemo Companion";

    /// <summary>Leaf directory for local and roaming app-owned data.</summary>
    public const string DataDirectoryName = "LuckyNemoTray";

    /// <summary>Single-instance mutex base name.</summary>
    public const string MutexBaseName = "LuckyNemoTray";

    /// <summary>Protocol scheme for deep links.</summary>
    public const string ProtocolScheme = "luckynemo";

    /// <summary>App-owned WSL distro used by embedded setup.</summary>
    public const string SetupDistroName = "LuckyNemoGateway";
    ...
    public static string ResolveLocalDataDirectory()
        => Environment.GetEnvironmentVariable("LUCKYNEMO_TRAY_DATA_DIR") is { Length: > 0 } overrideDir
            ? overrideDir
            : Path.Combine(
