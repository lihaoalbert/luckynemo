...
internal sealed class CliOptions
{
    ...
    public string Message { get; set; } = "luckynemo-cli validation ping";
...
internal static class Program
{
    private static async Task<int> Main(string[] args)
    {
        ...
        ILuckyNemoLogger logger = options.Verbose ? new ConsoleLogger() : NullLogger.Instance;
    ...
    private static void ApplyIdentityDefaults(CliOptions options, Func<string, string?> envLookup)
    {
        ...
        {
            options.SettingsPath = LuckyNemoAppIdentity.ResolveSettingsPath(envLookup, options.Identity);
        }
    }
    ...
    {
        Console.WriteLine("LuckyNemo CLI WebSocket validator");
        Console.WriteLine();
        Console.WriteLine("Reads the same tray settings file and runs chat.send checks over gateway WebSocket.");
        Console.WriteLine();
        Console.WriteLine("Usage:");
        Console.WriteLine("  dotnet run --project src/LuckyNemo.Cli -- [options]");
        Console.WriteLine();
        Console.WriteLine("Options:");
        Console.WriteLine("  --settings <path>            Settings file (default: selected identity profile)");
        Console.WriteLine("  --identity <release|dev>     Select tray profile (default: %LUCKYNEMO_APP_IDENTITY% or release)");
