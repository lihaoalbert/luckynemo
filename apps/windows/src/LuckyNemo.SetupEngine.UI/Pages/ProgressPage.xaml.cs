...
public sealed partial class ProgressPage : Page
{
    ...
    [
        ...
        ("install-cli", "Installing LuckyNemo", ["install-cli"]),
    ...
    {
        SubtitleText.Text = "Creating LuckyNemoGateway WSL instance: about 4 minutes left";
        ...
        LogText.Text =
            ...
            "[12:04:05] [info] wsl --install -d Ubuntu-24.04 --name LuckyNemoGateway --no-launch\n" +
            "[12:04:38] [info] downloading distro … 142/200 MB\n" +
            "[12:04:38] [changed] created %LOCALAPPDATA%\\LuckyNemoTray\\wsl\\LuckyNemoGateway\\\n" +
        ...
        try
        {
            ...
            if (success)
            {
                if (!config.SkipWizard)
                {
                    ...
                    // from install (gateway provisioning) into onboarding (the LuckyNemo wizard),
    ...
    private void Onboard_Click(object sender, RoutedEventArgs e)
    {
        ...
        MilestoneStatusText.Text = "Another setup task is still active. Wait for it to finish, then start LuckyNemo onboard.";
    }
