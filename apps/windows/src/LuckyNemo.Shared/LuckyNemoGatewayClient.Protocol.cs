...
// luckynemo/luckynemo schemas exactly:
...
// testable directly (InternalsVisibleTo LuckyNemo.Shared.Tests), reusing the
// private static JsonElement helpers declared in LuckyNemoGatewayClient.cs.
// ─────────────────────────────────────────────────────────────────────────────
public partial class LuckyNemoGatewayClient
{
    // ── sessions.reset ──
