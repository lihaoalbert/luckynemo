...
public static class DeepLinkParser
{
    ...
    public static DeepLinkResult? ParseDeepLink(string? uri, string scheme)
    {
        ...
        // Windows-canonicalized form `luckynemo://send/?args=...` (slash
