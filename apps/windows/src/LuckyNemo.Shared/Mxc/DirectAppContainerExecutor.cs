...
namespace LuckyNemo.Shared.Mxc;
...
public sealed class DirectAppContainerExecutor : ISandboxExecutor
{
    ...
    /// </summary>
    public const string LogFullConfigEnvVar = "LUCKYNEMO_MXC_LOG_FULL_CONFIG";
    ...
    /// </summary>
    public DirectAppContainerExecutor(Func<MxcAvailability> availabilityProvider, ILuckyNemoLogger? logger = null)
    {
    ...
    {
        var dir = Path.Combine(Path.GetTempPath(), "luckynemo-mxc-" + Guid.NewGuid().ToString("N").Substring(0, 12));
