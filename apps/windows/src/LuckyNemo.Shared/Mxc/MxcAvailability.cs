...
public sealed class MxcAvailability
{
    ...
    /// through environment variable <c>LUCKYNEMO_WXC_EXEC</c>.
    /// </summary>
    public const string WxcExecOverrideEnvVar = "LUCKYNEMO_WXC_EXEC";
    ...
    /// </summary>
    public static MxcAvailability Probe(ILuckyNemoLogger? logger = null)
        => Probe(logger, probeRunner: null);

    /// <summary>
    /// Test seam for <see cref="Probe(ILuckyNemoLogger?)"/>. <paramref name="probeRunner"/>
