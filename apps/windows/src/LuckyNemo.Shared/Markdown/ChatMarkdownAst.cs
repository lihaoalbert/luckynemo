...
namespace LuckyNemo.Shared.Markdown;
...
/// and consumed by the WinUI-side renderer in <c>LuckyNemo.Tray.WinUI</c>.
///
/// Lives in <c>LuckyNemo.Shared</c> (pure <c>net10.0</c>, no WinUI) so the
