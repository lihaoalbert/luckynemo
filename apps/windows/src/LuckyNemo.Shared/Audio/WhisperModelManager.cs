...
namespace LuckyNemo.Shared.Audio;

/// <summary>
/// Manages Whisper GGML model downloads, storage, and lifecycle.
/// Models are stored in <c>%APPDATA%\LuckyNemoTray\models\</c> (or the
...
public sealed class WhisperModelManager
{
    ...
    public WhisperModelManager(string dataDirectory, ILuckyNemoLogger logger)
    {
