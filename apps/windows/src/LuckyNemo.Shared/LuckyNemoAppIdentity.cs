...
/// </summary>
public static class LuckyNemoAppIdentity
{
    public const string ReleaseIdentity = "release";
    public const string DevIdentity = "dev";
    public const string IdentityEnvironmentVariable = "LUCKYNEMO_APP_IDENTITY";
    public const string DataDirectoryOverrideEnvironmentVariable = "LUCKYNEMO_TRAY_DATA_DIR";
    public const string AppDataRootEnvironmentVariable = "LUCKYNEMO_TRAY_APPDATA_DIR";
    public const string ReleaseDataDirectoryName = "LuckyNemoTray";
    public const string DevDataDirectoryName = "LuckyNemoTray-Dev";
