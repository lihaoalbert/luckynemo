...
public class DeviceIdentity
{
    ...
    public static string? TryReadStoredDeviceToken(string dataPath, ILuckyNemoLogger? logger = null) =>
        ReadStoredDeviceToken(dataPath, logger).Token;

    public static DeviceTokenReadResult ReadStoredDeviceToken(string dataPath, ILuckyNemoLogger? logger = null) =>
        ReadStoredDeviceTokenForRole(dataPath, "operator", logger);

    public static string? TryReadStoredDeviceTokenForRole(string dataPath, string role, ILuckyNemoLogger? logger = null) =>
        ReadStoredDeviceTokenForRole(dataPath, role, logger).Token;

    public static DeviceTokenReadResult ReadStoredDeviceTokenForRole(string dataPath, string role, ILuckyNemoLogger? logger = null)
    {
    ...
    public static bool HasStoredDeviceToken(string dataPath, ILuckyNemoLogger? logger = null) =>
        !string.IsNullOrWhiteSpace(TryReadStoredDeviceToken(dataPath, logger));

    public static bool HasStoredDeviceTokenForRole(string dataPath, string role, ILuckyNemoLogger? logger = null) =>
    ...
    /// (idempotent skip).
    /// </returns>
    public static bool TryClearDeviceToken(string dataPath, ILuckyNemoLogger? logger = null) =>
    ...
    /// </returns>
    public static bool TryClearAllDeviceTokens(string dataPath, ILuckyNemoLogger? logger = null)
    {
        var keyPath = Path.Combine(dataPath, "device-key-ed25519.json");
        if (!File.Exists(keyPath))
            return false;
    ...
    /// </returns>
    public static bool TryClearDeviceTokenForRole(string dataPath, string role, ILuckyNemoLogger? logger = null)
    {
        var tokenRole = ParseDeviceTokenRole(role);
        var keyPath = Path.Combine(dataPath, "device-key-ed25519.json");
        if (!File.Exists(keyPath))
    ...
    public DeviceIdentity(string dataPath, ILuckyNemoLogger? logger = null)
    {
    ...
    /// Same shape as <see cref="LuckyNemo.Shared.Mcp.McpAuthToken"/>.
    /// </summary>
