...
/// <c>%APPDATA%\LuckyNemoTray\mcp-token.txt</c> (the exact path is composed by
...
/// <c>LUCKYNEMO_TRAY_DATA_DIR</c> isolates the token file too.
///
...
public static class McpAuthToken
{
    ...
    /// the live location for LuckyNemo Tray installations — it's only a default
    ...
    public static string DefaultPath
    {
        get
        {
            ...
            return Path.Combine(root, "LuckyNemo", FileName);
        }
    }
