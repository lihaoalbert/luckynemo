...
public record ChatDataSnapshot(
    ...
    IReadOnlyList<LuckyNemo.Shared.GatewayCommand>? AvailableCommands = null,
...
/// LuckyNemo gateway, there is always a canonical "main" target whose session
...
public interface IChatDataProvider : IAsyncDisposable
{
    ...
    Task SendMessageAsync(string threadId, string message, CancellationToken cancellationToken, IReadOnlyList<LuckyNemo.Shared.ChatAttachment>? attachments) =>
