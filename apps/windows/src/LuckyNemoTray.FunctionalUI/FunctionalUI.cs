...
namespace LuckyNemoTray.FunctionalUI.Core
{
...
public sealed record NavigationHostElement<TRoute>(
    LuckyNemoTray.FunctionalUI.Navigation.NavigationHandle<TRoute> Handle,
    Func<TRoute, Element> RenderRoute) : Element, INavigationHostElement where TRoute : notnull
{
    public LuckyNemoTray.FunctionalUI.Navigation.NavigationTransition? Transition { get; init; }
...
public abstract class Component
{
    ...
    protected LuckyNemoTray.FunctionalUI.Navigation.NavigationHandle<TRoute> UseNavigation<TRoute>(TRoute initial)
...
internal sealed class NavigationHookState<TRoute>(
    LuckyNemoTray.FunctionalUI.Navigation.NavigationHandle<TRoute> handle) : IHookState
    where TRoute : notnull
{
    public LuckyNemoTray.FunctionalUI.Navigation.NavigationHandle<TRoute> Handle { get; } = handle;
}
...
public sealed class RenderContext
{
    ...
    public LuckyNemoTray.FunctionalUI.Navigation.NavigationHandle<TRoute> UseNavigation<TRoute>(TRoute initial)
        where TRoute : notnull
    {
        if (_hookIndex >= _hooks.Count)
        {
            var handle = new LuckyNemoTray.FunctionalUI.Navigation.NavigationHandle<TRoute>(initial);
...
namespace LuckyNemoTray.FunctionalUI.Navigation
{
...
namespace LuckyNemoTray.FunctionalUI
{

using LuckyNemoTray.FunctionalUI.Core;
using LuckyNemoTray.FunctionalUI.Navigation;
...
namespace LuckyNemoTray.FunctionalUI.Hosting
{
...
internal sealed class UiRenderer(Action requestRender)
{
    ...
    private static Microsoft.UI.Xaml.Controls.MenuFlyoutItemBase CreateMenuFlyoutItem(LuckyNemoTray.FunctionalUI.Core.MenuFlyoutItemBase item)
    {
        switch (item)
        {
