...
public class NodePairAutoApproveTests : IDisposable
{
    ...
    {
        _tempDir = Path.Combine(Path.GetTempPath(), "luckynemo-autoapprove-" + Guid.NewGuid().ToString("N")[..8]);
    ...
    internal sealed class TrackingLifecycle : IGatewayClientLifecycle
    {
        ...
        public LuckyNemoGatewayClient DataClient => TrackingClient;
...
#pragma warning restore CS0067
    ...
    internal sealed class TrackingGatewayClient : LuckyNemoGatewayClient
    {
