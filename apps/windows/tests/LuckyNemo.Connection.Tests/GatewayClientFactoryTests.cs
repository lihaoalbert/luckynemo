...
public sealed class GatewayClientFactoryTests
{
    ...
    {
        var tempDir = Path.Combine(Path.GetTempPath(), "luckynemo-gateway-factory-" + Guid.NewGuid().ToString("N"));
    ...
    private static string GetConnectRole(LuckyNemoGatewayClient client)
    {
