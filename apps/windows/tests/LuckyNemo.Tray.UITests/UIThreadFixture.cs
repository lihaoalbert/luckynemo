...
///   - Renderers like <see cref="LuckyNemoTray.A2UI.Rendering.Renderers.TextRenderer"/>
...
public sealed class UIThreadFixture : IDisposable
{
    ...
    public UIThreadFixture()
    {
        ...
        var timeoutSeconds = int.TryParse(
            Environment.GetEnvironmentVariable("LUCKYNEMO_UI_FIXTURE_TIMEOUT_SECONDS"),
