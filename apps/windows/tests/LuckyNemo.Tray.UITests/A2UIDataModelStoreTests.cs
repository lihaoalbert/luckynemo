...
using LuckyNemoTray.A2UI.Theming;
using Xunit;
...
/// the production <see cref="LuckyNemoTray.A2UI.DataModel.DataModelStore"/>.
///
/// These run on the UI thread because the store is dispatcher-affine. The parser
/// happy paths live in LuckyNemo.Tray.Tests/A2UIDataModelArrayTests; here we pin
