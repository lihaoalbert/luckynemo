...
public static class A2UI
{
    ...
    /// to the v0.8 surface theme — see <see cref="LuckyNemoTray.A2UI.Theming.A2UITheme"/>.
    /// </summary>
    ...
    /// <see cref="Surface"/>. Mirrors what <see cref="LuckyNemoTray.A2UI.Theming.A2UITheme.Parse"/>
    /// reads on the wire.
    /// </summary>
