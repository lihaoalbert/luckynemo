...
{
    private const string RawTitle = "LuckyNemo Windows Tray";
    private const string ForkTitle = "LuckyNemo Windows Tray (2)";
    ...
    public async Task DuplicateTitles_RenderDistinctly_AndOpenChatUsesOriginalKeys()
    {
        ...
        {
            $"head={Environment.GetEnvironmentVariable("LUCKYNEMO_UI_PROOF_HEAD") ?? "local"}",
    ...
    {
        var configuredPath = Environment.GetEnvironmentVariable("LUCKYNEMO_UI_PROOF_PATH");
