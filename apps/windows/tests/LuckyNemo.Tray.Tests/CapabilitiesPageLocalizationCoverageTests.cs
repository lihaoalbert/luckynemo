...
public sealed class CapabilitiesPageLocalizationCoverageTests
{
    ...
    private static string GetCapabilitiesXamlPath() =>
        Path.Combine(TestRepositoryPaths.GetRepositoryRoot(), "src", "LuckyNemo.Tray.WinUI", "Pages", "PermissionsPage.xaml");

    private static string GetCapabilitiesCodeBehindPath() =>
        Path.Combine(TestRepositoryPaths.GetRepositoryRoot(), "src", "LuckyNemo.Tray.WinUI", "Pages", "PermissionsPage.xaml.cs");

    private static string GetEnUsReswPath() =>
        Path.Combine(TestRepositoryPaths.GetRepositoryRoot(), "src", "LuckyNemo.Tray.WinUI", "Strings", "en-us", "Resources.resw");

    private static string GetVoiceSettingsXamlPath() =>
        Path.Combine(TestRepositoryPaths.GetRepositoryRoot(), "src", "LuckyNemo.Tray.WinUI", "Pages", "VoiceSettingsPage.xaml");

    private static string GetVoiceSettingsCodeBehindPath() =>
        Path.Combine(TestRepositoryPaths.GetRepositoryRoot(), "src", "LuckyNemo.Tray.WinUI", "Pages", "VoiceSettingsPage.xaml.cs");
