...
public sealed class OpenTelemetryEndpointConnectionTests
{
    ...
    public void Probe_UsesGatewayAlignedTelemetryConstants()
    {
        ...
        Assert.Equal("LuckyNemo.Telemetry.Exporter", OpenTelemetryLogPolicy.TelemetryExporterCategory);
    ...
    [Theory]
    [InlineData("LuckyNemo.Telemetry.Exporter", LogLevel.Information, true)]
    [InlineData("LuckyNemo.Telemetry.Connection", LogLevel.Warning, true)]
    [InlineData("LuckyNemo.Telemetry.NodeTool", LogLevel.Warning, true)]
    [InlineData("LuckyNemo.Telemetry.Exporter", LogLevel.Debug, false)]
    [InlineData("LuckyNemo.Telemetry.Exporter", LogLevel.None, false)]
    [InlineData("LuckyNemoTray.Services.GatewayService", LogLevel.Warning, false)]
    ...
    public void NodeToolLogAttributes_ContainOnlyReviewedFields()
    {
        ...
        Assert.Equal(
            [
                ...
                "luckynemo.node.tool.duration_ms",
    ...
    public void ProviderRuntime_IsAppLevel_NotDebugPageOwned()
    {
        ...
        var debugPage = File.ReadAllText(Path.Combine(root, "src", "LuckyNemo.Tray.WinUI", "Pages", "DebugPage.xaml.cs"));
    ...
    {
        var dir = Path.Combine(Path.GetTempPath(), "LuckyNemo.Tray.Tests", Guid.NewGuid().ToString("N"));
