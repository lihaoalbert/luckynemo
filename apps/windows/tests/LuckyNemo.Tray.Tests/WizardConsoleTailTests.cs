using LuckyNemo.SetupEngine.UI;
...
/// the root "luckynemo" logger via console.log should be surfaced; everything
/// else is noise.
/// </summary>
public class WizardConsoleTailTests
{
    ...
    {
        // Silent fallback during npm install of @luckynemo/codex.
        var line = """{"_meta":{"name":"luckynemo","logLevelName":"INFO","path":{"method":"console.log"}},"message":"Resolved @luckynemo/codex to @luckynemo/codex@2026.6.1, but that version is incompatible with this LuckyNemo runtime; using newest compatible @luckynemo/codex@2026.5.28"}""";
    ...
    {
        var line = """
            {"_meta":{"name":"luckynemo","logLevelName":"INFO","path":{"method":"console.log"}},"message":"\u001b[47m\u001b[30m██  ▄▄  ██\u001b[0m"}
            """;
    ...
    {
        var line = """
            {"_meta":{"name":"luckynemo","logLevelName":"INFO","path":{"method":"console.log"}},"message":"Open WhatsApp and scan:\n████ ▄▄ ████"}
            """;
    ...
    public void DoesNotTreatRegularMultilineConsoleOutputAsQrArt()
    {
        var message = """
            ...
            Docs: https://docs.luckynemo.ai/whatsapp
            """;
    ...
    {
        // luckynemo/auth, luckynemo/ws, gateway/ws etc. write structured records
        ...
        var line = """{"_meta":{"name":"luckynemo/auth","logLevelName":"INFO","path":{"method":"info"}},"message":"device token rotated"}""";

        Assert.Null(WizardConsoleTail.TryExtractConsoleMessage(line));
    }

    [Fact]
    public void IgnoresNonLuckyNemoNamedConsoleLog()
    {
        // Defense in depth: only the root luckynemo logger should surface to the
        // wizard banner. A console.log from some other subsystem stays internal.
        var line = """{"_meta":{"name":"luckynemo/ws","logLevelName":"INFO","path":{"method":"console.log"}},"message":"internal noise"}""";
    ...
    {
        var line = """{"_meta":{"name":"luckynemo","logLevelName":"INFO","path":{"method":"console.log"}}}""";
    ...
    {
        var line = """{"_meta":{"name":"luckynemo","logLevelName":"INFO","path":{"method":"console.log"}},"message":"   "}""";
    ...
    public void CheapRejectionFastPathStillAcceptsValidLines()
    {
        ...
        var line = """{"_meta":{"name":"luckynemo","logLevelName":"WARN","path":{"method":"console.log"}},"message":"install failed: npm ENOSPC"}""";
