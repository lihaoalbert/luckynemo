...
public sealed class SpeechInputContractTests
{
    ...
    {
        var cs = Read("src", "LuckyNemo.Tray.WinUI", "Services", "VoiceService.cs");
    ...
    {
        var cs = Read("src", "LuckyNemo.Tray.WinUI", "Services", "AudioPipeline.cs");
    ...
    {
        var chatPage = Read("src", "LuckyNemo.Tray.WinUI", "Pages", "ChatPage.xaml.cs");
        var chatWindow = Read("src", "LuckyNemo.Tray.WinUI", "Windows", "ChatWindow.xaml.cs");
    ...
    public void ChatVoiceDialogs_RouteDisabledTtsCapabilityToPermissions_AndPreserveFallbackForMissingSetup()
    {
        var chatPage = Read("src", "LuckyNemo.Tray.WinUI", "Pages", "ChatPage.xaml.cs");
        var chatWindow = Read("src", "LuckyNemo.Tray.WinUI", "Windows", "ChatWindow.xaml.cs");
        var permissionsPage = Read("src", "LuckyNemo.Tray.WinUI", "Pages", "PermissionsPage.xaml.cs");
        var resources = Read("src", "LuckyNemo.Tray.WinUI", "Strings", "en-us", "Resources.resw");
        ...
        Assert.Contains("SpeechSetupReadiness.IsAutomaticChatTtsEnabled", Read("src", "LuckyNemo.Tray.WinUI", "App.xaml.cs"));
        Assert.Contains("IsAutomaticChatTtsEnabled", Read("src", "LuckyNemo.Tray.WinUI", "Services", "SpeechSetupReadiness.cs"));
        Assert.Contains("return settings?.NodeTtsEnabled == true;", Read("src", "LuckyNemo.Tray.WinUI", "Services", "SpeechSetupReadiness.cs"));
