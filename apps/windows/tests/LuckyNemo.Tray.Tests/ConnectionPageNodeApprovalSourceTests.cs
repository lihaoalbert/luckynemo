...
public sealed class ConnectionPageNodeApprovalSourceTests
{
    ...
    {
        var planSource = ReadSource("src", "LuckyNemo.Tray.WinUI", "Pages", "ConnectionPagePlan.cs");
        ...
        Assert.Contains("\"luckynemo nodes pending\"", planSource);
    ...
    public void ConnectionPage_PassesLocalNodeAndRendersTrustApprovalAsCopyOnly()
    {
        ...
        var pageMarkup = ReadSource("src", "LuckyNemo.Tray.WinUI", "Pages", "ConnectionPage.xaml");
