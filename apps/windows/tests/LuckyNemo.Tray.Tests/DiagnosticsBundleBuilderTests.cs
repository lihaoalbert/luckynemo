...
public sealed class DiagnosticsBundleBuilderTests : IDisposable
{
    ...
    {
        var trayLog = Path.Combine(_tempDir, "luckynemo-tray.log");
    ...
    public void BuildCached_RegeneratesWhenDiagnosticStateContentChangesWithSameCounts()
    {
        ...
        var firstState = new GatewayCommandCenterState
        {
            ...
            [
                new CommandCenterActivityInfo
                {
                    ...
                    Title = "first warning",
                    Details = "gateway health path /home/luckynemo/.luckynemo/sessions/old/session.jsonl"
                }
            ]
        };
        var secondState = new GatewayCommandCenterState
        {
            ...
            [
                new CommandCenterActivityInfo
                {
                    ...
                    Details = "gateway health path /home/luckynemo/.luckynemo/sessions/new/session.jsonl"
                }
            ]
        };
        ...
        Assert.DoesNotContain("/home/luckynemo", second, StringComparison.OrdinalIgnoreCase);
    ...
    public void Build_RedactsLegacyPiiDuringExportWithoutRewritingSource()
    {
        ...
        File.WriteAllText(trayLog, @"Failed reading C:\Users\alice\AppData\Local\LuckyNemoTray\settings.json from alice@example.com" + "\n");
        File.WriteAllText(jsonl, """{"event":"test","metadata":{"path":"C:\\Users\\alice\\AppData\\Local\\LuckyNemoTray\\settings.json","ip":"10.1.2.3"}}""" + "\n");
        File.WriteAllText(crash, @"Unhandled at C:/Users/alice/source/repos/luckynemo-windows-node/App.xaml.cs via alice@host:22" + "\n");
        File.WriteAllText(rawChat, """{"arguments":{"command":"grep C:\\Users\\alice\\source\\repos\\luckynemo"}}""" + "\n");
    ...
    public void Build_NormalizesLegacySetupJsonlForExportWithoutRewritingSource()
    {
        ...
        File.WriteAllText(journalLog,
            """
            {"Timestamp":"2026-06-03T18:40:44.7873386+00:00","StepId":"wsl-create","Event":"completed","Detail":"Created clean WSL2 distro at C:\\Users\\alice\\AppData\\Local\\LuckyNemoTray\\wsl\\LuckyNemoGateway"}
            """);
    ...
    public void DiagnosticsJsonlService_SanitizesMetadataPropertyNamesBeforeSerialization()
    {
        var json = DiagnosticsJsonlService.FormatRecordLineForTest(
            ...
            new Dictionary<string, object?>
            {
                ...
                [@"path C:\Users\alice\AppData\Local\LuckyNemoTray\settings.json"] = "path value",
