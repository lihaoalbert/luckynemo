...
public sealed class SetupWindowArgumentProjectionTests
{
    ...
    {
        var projected = SetupWindowArgumentProjection.Project(
            ["LuckyNemo.Tray.WinUI.exe", "luckynemo://setup", "--config=custom.json"],
            value => value.StartsWith("luckynemo://", StringComparison.OrdinalIgnoreCase),
            currentProcessId: 1000);
    ...
    {
        var projected = SetupWindowArgumentProjection.Project(
            ["LuckyNemo.Tray.WinUI.exe", "--config", "luckynemo://config"],
            value => value.StartsWith("luckynemo://", StringComparison.OrdinalIgnoreCase),
            currentProcessId: 1000);

        Assert.Equal(["--config", "luckynemo://config"], projected);
    }
    ...
    {
        var projected = SetupWindowArgumentProjection.Project(
            ["LuckyNemo.Tray.WinUI.exe", hostOption, followingOption, "custom.json"],
            _ => false,
            currentProcessId: 1000);
    ...
    {
        var projected = SetupWindowArgumentProjection.Project(
            ["LuckyNemo.Tray.WinUI.exe", hostOption],
            _ => false,
            currentProcessId: 1000);
    ...
    {
        var projected = SetupWindowArgumentProjection.Project(
            ["LuckyNemo.Tray.WinUI.exe", "--wait-for-pid", " "],
            _ => false,
            currentProcessId: 1000);
    ...
    {
        var projected = SetupWindowArgumentProjection.Project(
            ["LuckyNemo.Tray.WinUI.exe", "--wait-for-pid", value, "--config", "custom.json"],
            _ => false,
            currentProcessId: 1000);
    ...
    {
        var projected = SetupWindowArgumentProjection.Project(
            ["LuckyNemo.Tray.WinUI.exe", "--post-setup-launch", value, "--config", "custom.json"],
            _ => false,
            currentProcessId: 1000);
