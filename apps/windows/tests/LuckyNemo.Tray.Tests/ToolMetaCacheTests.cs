...
{
    private static LuckyNemoChatDataProvider.CachedToolMeta Meta(long ts, string tool, string label) =>
    ...
    {
        Assert.Null(LuckyNemoChatDataProvider.TryMatchCachedTool(null, 1000));
    }

    [Fact]
    public void TryMatch_EmptyCache_ReturnsNull()
    {
        var cache = new Queue<LuckyNemoChatDataProvider.CachedToolMeta>();
        Assert.Null(LuckyNemoChatDataProvider.TryMatchCachedTool(cache, 1000));
    }
    ...
    public void TryMatch_SingleEntry_DequeuesAndReturns()
    {
        ...
        var result = LuckyNemoChatDataProvider.TryMatchCachedTool(cache, 200);
    ...
    public void TryMatch_SequentialOrder_MatchesByPosition()
    {
        ...
        var r1 = LuckyNemoChatDataProvider.TryMatchCachedTool(cache, 500);
        var r2 = LuckyNemoChatDataProvider.TryMatchCachedTool(cache, 600);
        var r3 = LuckyNemoChatDataProvider.TryMatchCachedTool(cache, 700);
    ...
    public void TryMatch_MoreHistoryThanCache_ReturnsNullWhenExhausted()
    {
        ...
        var r1 = LuckyNemoChatDataProvider.TryMatchCachedTool(cache, 200);
        var r2 = LuckyNemoChatDataProvider.TryMatchCachedTool(cache, 300);
    ...
    public void TryMatch_CachedEntryFarAfterHistory_SkipsMatch()
    {
        ...
        var result = LuckyNemoChatDataProvider.TryMatchCachedTool(cache, 100_000);
    ...
    public void TryMatch_ZeroTimestamps_AlwaysMatch()
    {
        ...
        var result = LuckyNemoChatDataProvider.TryMatchCachedTool(cache, 0);
    ...
    {
        Assert.Equal(20, LuckyNemoChatDataProvider.MaxCachedSessions);
        Assert.Equal(500, LuckyNemoChatDataProvider.MaxToolEntriesPerSession);
    }
    ...
    public async Task CacheToolMeta_ConcurrentAdds_FlushesCompleteValidJson()
    {
        ...
        var provider = new LuckyNemoChatDataProvider(bridge, post: null, toolMetaCacheFilePath: cachePath);
        ...
        var cache = JsonSerializer.Deserialize<Dictionary<string, List<LuckyNemoChatDataProvider.CachedToolMeta>>>(json);
    ...
    public async Task Constructor_DoesNotRewriteLegacyEscapedToolMetaCache()
    {
        ...
        var provider = new LuckyNemoChatDataProvider(new FakeBridge(), post: null, toolMetaCacheFilePath: cachePath);
        await provider.DisposeAsync();
    ...
    {
        public string DirectoryPath { get; } = Path.Combine(Path.GetTempPath(), "luckynemo-tool-meta-" + Guid.NewGuid().ToString("N"));
