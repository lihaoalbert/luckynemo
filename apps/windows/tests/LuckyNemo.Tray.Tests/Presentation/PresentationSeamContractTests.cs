...
namespace LuckyNemo.Tray.Tests.Presentation;
...
public sealed class PresentationSeamContractTests
{
    ...
    public void App_BuildsServiceProvider_WithScopeAndBuildValidation()
    {
        ...
        Assert.Contains("AddLuckyNemoTrayCore", source);
    ...
    public void PresentationAdapters_StayWinUiBound_AndAreNotLinkedIntoPureTests()
    {
        ...
        var csproj = File.ReadAllText(Path.Combine(
            TestRepositoryPaths.GetRepositoryRoot(), "tests", "LuckyNemo.Tray.Tests", "LuckyNemo.Tray.Tests.csproj"));
    ...
    private static string PresentationDir =>
        Path.Combine(TestRepositoryPaths.GetRepositoryRoot(), "src", "LuckyNemo.Tray.WinUI", "Presentation");
    ...
    {
        var appDir = Path.Combine(TestRepositoryPaths.GetRepositoryRoot(), "src", "LuckyNemo.Tray.WinUI");
        return string.Join(
            "\n",
            Directory
    ...
    private static string ReadHubWindowSource()
    {
        return File.ReadAllText(Path.Combine(
            TestRepositoryPaths.GetRepositoryRoot(), "src", "LuckyNemo.Tray.WinUI", "Windows", "HubWindow.xaml.cs"));
    }
}
