...
/// <summary>
/// Pins source-level UI contracts because LuckyNemo.Tray.Tests cannot reference
...
public sealed class NodeModeUiStateTests
{
    ...
    {
        var plan = ReadSource("src", "LuckyNemo.Tray.WinUI", "Pages", "ConnectionPagePlan.cs");
        ...
        int expectedMode)
    {
        var settingsDirectory = Path.Combine(
            Path.GetTempPath(),
            "luckynemo-node-mode-ui-" + Guid.NewGuid().ToString("N"));
        try
        {
    ...
    {
        var page = ReadSource("src", "LuckyNemo.Tray.WinUI", "Pages", "ConnectionPage.xaml.cs");
    ...
    {
        var app = ReadSource("src", "LuckyNemo.Tray.WinUI", "App.xaml.cs");
    ...
    {
        var page = ReadSource("src", "LuckyNemo.Tray.WinUI", "Pages", "PermissionsPage.xaml.cs");
    ...
    {
        var service = ReadSource("src", "LuckyNemo.Tray.WinUI", "Services", "NodeService.cs");
    ...
    {
        var resw = ReadSource(
            "src", "LuckyNemo.Tray.WinUI", "Strings", "en-us", "Resources.resw");
