...
public class ChatTimelineReducerTests
{
    ...
    public void NewTurnFinalAssistant_DoesNotOverwriteFinalizedPreviousAssistant()
    {
        ...
        //
        // LuckyNemoChatDataProvider always tags chat.message events with
    ...
    // (the rendering layer in LuckyNemoChatTimeline reorders them for display).

    [Fact]
    public void ToolError_ThenFinalAssistant_ProducesToolAndAssistantEntries()
    {
        var state = ChatTimelineState.Initial();
        state = ChatTimelineReducer.Apply(state, new ChatToolStartEvent("run nodes", "luckynemo", ToolCallId: "tc1"));
    ...
    public void ToolError_ThenFinalAssistant_ToolEntryPrecedesAssistantInState()
    {
        ...
        // The rendering layer (LuckyNemoChatTimeline) reorders ToolCall entries to
    ...
    public void TurnEnd_PreservesPendingPermission()
    {
        ...
        // banner — not turn-end. See LuckyNemoChatDataProvider's approval
    ...
    public void IntraTurnFinalAfterTool_StripsCumulativePrefixFromPriorBubble()
    {
        ...
        // turn (see LuckyNemoChatDataProvider.OnChatMessageReceived's comment
