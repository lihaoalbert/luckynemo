...
using ConnectionManagerWindowsNodeConnector = LuckyNemoTray.Services.ConnectionManagerWindowsNodeConnector;
...
public sealed class ConnectionManagerWindowsNodeConnectorTests : IDisposable
{
    ...
    {
        _tempDir = Path.Combine(Path.GetTempPath(), "luckynemo-cmwnc-" + Guid.NewGuid().ToString("N")[..8]);
    ...
    private sealed class StubLifecycle : IGatewayClientLifecycle
    {
        ...
        public LuckyNemoGatewayClient DataClient { get; }
...
#pragma warning restore CS0067
    ...
    private sealed class StubGatewayClient : LuckyNemoGatewayClient
    {
