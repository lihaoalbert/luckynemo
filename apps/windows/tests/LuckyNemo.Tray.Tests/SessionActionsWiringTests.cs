...
public sealed class SessionActionsWiringTests
{
    ...
    {
        var source = ReadSource("src", "LuckyNemo.Tray.WinUI", "Pages", "SessionsPage.xaml.cs");
    ...
    {
        var xaml = ReadSource("src", "LuckyNemo.Tray.WinUI", "Pages", "SessionsPage.xaml");
    ...
    {
        var source = ReadSource("src", "LuckyNemo.Tray.WinUI", "App.xaml.cs");
    ...
    {
        var source = ReadSource("src", "LuckyNemo.Tray.WinUI", "Helpers", "SessionActionPromptLocalizer.cs");
        ...
        var stringsRoot = Path.Combine(GetRepositoryRoot(), "src", "LuckyNemo.Tray.WinUI", "Strings");
