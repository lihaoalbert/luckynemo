...
public sealed class DiagnosticsPageContractTests
{
    ...
    {
        var xaml = Read("src", "LuckyNemo.Tray.WinUI", "Pages", "DebugPage.xaml");
    ...
    {
        var xaml = Read("src", "LuckyNemo.Tray.WinUI", "Pages", "DebugPage.xaml");
        var cs = Read("src", "LuckyNemo.Tray.WinUI", "Pages", "DebugPage.xaml.cs");
    ...
    {
        var source = Read("src", "LuckyNemo.Tray.WinUI", "Helpers", "DiagnosticsGate.cs");
    ...
    {
        var source = Read("src", "LuckyNemo.Tray.WinUI", "Windows", "HubWindow.xaml.cs");
    ...
    public void DebugPage_UsesFluentIconCatalog_NotLiteralGlyphs()
    {
        ...
        var xaml = Read("src", "LuckyNemo.Tray.WinUI", "Pages", "DebugPage.xaml");
        Assert.Contains("xmlns:helpers=\"using:LuckyNemoTray.Helpers\"", xaml);
    ...
    public void DebugPage_DoesNotDuplicateSettingsSetupEntryPoint()
    {
        ...
        var settings = Read("src", "LuckyNemo.Tray.WinUI", "Pages", "SettingsPage.xaml");
    ...
    {
        var xaml = Read("src", "LuckyNemo.Tray.WinUI", "Windows", "DiagnosticsBundleDialog.xaml");
        ...
        var cs = Read("src", "LuckyNemo.Tray.WinUI", "Windows", "DiagnosticsBundleDialog.xaml.cs");
    ...
    {
        var cs = Read("src", "LuckyNemo.Tray.WinUI", "AppLogger.cs");
    ...
    {
        var settingsXaml = Read("src", "LuckyNemo.Tray.WinUI", "Pages", "SettingsPage.xaml");
        var settingsCs = Read("src", "LuckyNemo.Tray.WinUI", "Pages", "SettingsPage.xaml.cs");
        var hub = Read("src", "LuckyNemo.Tray.WinUI", "Windows", "HubWindow.xaml.cs");
        ...
        Assert.False(File.Exists(Path.Combine(repoRoot, "src", "LuckyNemo.Tray.WinUI", "Pages", "AboutPage.xaml")));
        Assert.False(File.Exists(Path.Combine(repoRoot, "src", "LuckyNemo.Tray.WinUI", "Pages", "AboutPage.xaml.cs")));
    }
    ...
    public void HubWindow_DebugNavItem_RoutesUnchanged_LabelRenamed()
    {
        ...
        // "Diagnostics".
        var xaml = Read("src", "LuckyNemo.Tray.WinUI", "Windows", "HubWindow.xaml");
        Assert.Contains("Tag=\"debug\"", xaml);

        var resw = Read("src", "LuckyNemo.Tray.WinUI", "Strings", "en-us", "Resources.resw");
        ...
        var cs = Read("src", "LuckyNemo.Tray.WinUI", "Windows", "HubWindow.xaml.cs");
    ...
    public void HubWindow_NavPaneToggle_LivesInTitleBarAndHidesBuiltInToggle()
    {
        ...
        Assert.Contains("xmlns:controls=\"using:LuckyNemoTray.Controls\"", xaml);
    ...
    public void DebugPage_ObservesAppState_NotHubWindow()
    {
        ...
        var app = Read("src", "LuckyNemo.Tray.WinUI", "App.xaml.cs");
    ...
    {
        var helper = Read("src", "LuckyNemo.Tray.WinUI", "Helpers", "CommandCenterTextHelper.cs");
    ...
    public void CommandCenterTextHelper_DebugBundle_IsSummaryOnlyWithoutLogTail()
    {
        var helper = Read("src", "LuckyNemo.Tray.WinUI", "Helpers", "CommandCenterTextHelper.cs");
        var xaml = Read("src", "LuckyNemo.Tray.WinUI", "Pages", "DebugPage.xaml");
        var resources = Read("src", "LuckyNemo.Tray.WinUI", "Strings", "en-us", "Resources.resw");
    ...
    {
        var page = Read("src", "LuckyNemo.Tray.WinUI", "Pages", "DebugPage.xaml.cs");
        var service = Read("src", "LuckyNemo.Tray.WinUI", "Services", "DiagnosticsClipboardService.cs");
        var builder = Read("src", "LuckyNemo.Tray.WinUI", "Services", "DiagnosticsBundleBuilder.cs");
        ...
        Assert.Contains(
            ...
            Read("src", "LuckyNemo.Tray.WinUI", "Windows", "ConnectionStatusWindow.xaml.cs"));
    ...
    public void CommandCenterTextHelper_NodeInventoryIncludesTrustDiagnostics()
    {
        ...
        Assert.Contains("LuckyNemo node inventory", helper);
    ...
    {
        var logger = Read("src", "LuckyNemo.Tray.WinUI", "Services", "Logger.cs");
        Assert.Contains("TokenSanitizer.SanitizeLogMessage(message)", logger);

        var diagnosticsJsonl = Read("src", "LuckyNemo.Tray.WinUI", "Services", "DiagnosticsJsonlService.cs");
        ...
        var crashLogger = Read("src", "LuckyNemo.Tray.WinUI", "Services", "AppCrashLogger.cs");
