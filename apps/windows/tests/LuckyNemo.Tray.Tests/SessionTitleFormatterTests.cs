...
public sealed class SessionTitleFormatterTests
{
    ...
    public void Format_DistinguishesForkFromCanonicalSessionWithSameDisplayName()
    {
        ...
        Assert.Equal("LuckyNemo Windows Tray", canonicalTitle);
        Assert.Equal("LuckyNemo Windows Tray (2)", forkTitle);
    ...
    {
        var thread = new LuckyNemo.Chat.ChatThread
        {
