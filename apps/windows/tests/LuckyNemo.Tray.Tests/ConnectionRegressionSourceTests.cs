...
public sealed class ConnectionRegressionSourceTests
{
    ...
    {
        var appSource = ReadSource("src", "LuckyNemo.Tray.WinUI", "App.xaml.cs");
    ...
    {
        var pageSource = ReadSource("src", "LuckyNemo.Tray.WinUI", "Pages", "ConnectionPage.xaml.cs");
    ...
    {
        var appSource = ReadSource("src", "LuckyNemo.Tray.WinUI", "App.CapabilityHandlers.cs");
    ...
    {
        var managerSource = ReadSource("src", "LuckyNemo.Connection", "GatewayConnectionManager.cs");
    ...
    {
        var source = ReadSource("src", "LuckyNemo.Shared", "LuckyNemoGatewayClient.cs");
    ...
    {
        var source = ReadSource("src", "LuckyNemo.Cli", "Program.cs");
        ...
        AssertInOrder(
            ...
            "options.IdentityDataPath = LuckyNemoAppIdentity.ResolveRoamingDataDirectory(envLookup, options.Identity);");
    }

    [Fact]
    public void SetupKeepalive_DisposesProcessWrapperAfterWritingMarker()
    {
        var source = ReadSource("src", "LuckyNemo.SetupEngine", "SetupSteps.cs");
