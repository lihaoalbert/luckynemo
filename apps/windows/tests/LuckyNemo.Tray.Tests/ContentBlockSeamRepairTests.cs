...
/// <summary>
/// Unit tests for <see cref="LuckyNemoChatDataProvider.RepairContentBlockSeams"/>.
...
public class ContentBlockSeamRepairTests
{
    ...
    {
        Assert.Equal(expected, LuckyNemoChatDataProvider.RepairContentBlockSeams(input));
    }
    ...
    {
        Assert.Equal(input, LuckyNemoChatDataProvider.RepairContentBlockSeams(input));
    }

    [Fact]
    public void NullInputReturnsEmpty()
    {
        Assert.Equal(string.Empty, LuckyNemoChatDataProvider.RepairContentBlockSeams(null));
    }
    ...
    public void RepairIsIdempotent()
    {
        ...
        var once = LuckyNemoChatDataProvider.RepairContentBlockSeams(raw);
        var twice = LuckyNemoChatDataProvider.RepairContentBlockSeams(once);
