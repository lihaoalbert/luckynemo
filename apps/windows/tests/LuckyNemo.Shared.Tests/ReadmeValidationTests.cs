...
public class ReadmeValidationTests
{
    ...
    private static string GetRepositoryRoot()
    {
        ...
        {
            // Monorepo marker: apps/windows owns the slnx; walking up to the
            // monorepo root (.git + README.md) would resolve the wrong root.
        ...
        throw new InvalidOperationException("Could not find repository root. Set LUCKYNEMO_REPO_ROOT to the repo path.");
    }
}
