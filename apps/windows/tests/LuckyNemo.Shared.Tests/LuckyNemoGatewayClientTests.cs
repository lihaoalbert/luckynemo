...
public class LuckyNemoGatewayClientTests
{
    ...
    private class GatewayClientTestHelper
    {
        ...
        public LuckyNemoGatewayClient Client => _client;
            ...
            string? identityPath = null)
        {
            ...
            _client = new LuckyNemoGatewayClient(
                gatewayUrl,
                "test-token",
                new TestLogger(),
        ...
        public GatewayClientTestHelper(ILuckyNemoLogger logger)
        {
            _client = new LuckyNemoGatewayClient(
                "ws://localhost:18789",
                "test-token",
        ...
        {
            var method = typeof(LuckyNemoGatewayClient).GetMethod("ClassifyTool",
        ...
        {
            var method = typeof(LuckyNemoGatewayClient).GetMethod("ShortenPath",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);
        ...
        public Task<ChatSendResult> RegisterPendingChatSend(string requestId)
        {
            ...
            var method = typeof(LuckyNemoGatewayClient).GetMethod(
        ...
        {
            var identityField = typeof(LuckyNemoGatewayClient).GetField(
                "_deviceIdentity",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        ...
        {
            var methodInfo = typeof(LuckyNemoGatewayClient).GetMethod(
                "TrackPendingRequest",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
    ...
    private static string CreateTempIdentityPath() =>
        Path.Combine(Path.GetTempPath(), "LuckyNemoGatewayClientTests", Guid.NewGuid().ToString("N"));
    ...
    private class TestLogger : ILuckyNemoLogger
    {
    ...
    [Fact]
    public void ProcessRawMessage_SessionMessageWithLuckyNemoMetadata_EmitsMessageIdentity()
    {
        var helper = new GatewayClientTestHelper();
        ChatMessageInfo? received = null;
        helper.Client.ChatMessageReceived += (_, message) => received = message;
        ...
        Assert.NotNull(received);
        Assert.Equal("msg-user-a", received!.LuckyNemoId);
        Assert.Equal(42, received.LuckyNemoSeq);
    }
    ...
    public void ProcessRawMessage_SessionMessageAssistantNoReply_DropsFrame()
    {
        var helper = new GatewayClientTestHelper();
        ChatMessageInfo? received = null;
        LuckyNemoNotification? notification = null;
        helper.Client.ChatMessageReceived += (_, message) => received = message;
    ...
    [Fact]
    public void ParseChatHistoryPayload_LuckyNemoMetadata_PreservesMessageIdentity()
    {
        var helper = new GatewayClientTestHelper();
        ...
        Assert.Equal("msg-history-a", message.LuckyNemoId);
        Assert.Equal(7, message.LuckyNemoSeq);
    }
    ...
    public void ParseChatHistoryPayload_CompactionMetadata_PreservesBoundaryDetails()
    {
        ...
        var message = Assert.Single(history.Messages);
        Assert.Equal("compaction", message.LuckyNemoKind);
    ...
    public void ParseChatHistoryPayload_MalformedCompactionMetadata_IsIgnored()
    {
        ...
        var message = Assert.Single(history.Messages);
        Assert.Null(message.LuckyNemoKind);
    ...
    public void ProcessRawMessage_LiveCompaction_PreservesBoundaryDetails()
    {
        ...
        Assert.NotNull(received);
        Assert.Equal("compaction", received!.LuckyNemoKind);
    ...
    public void ParseSessions_ProjectsGatewayPresentationContract()
    {
        ...
        [
          {
            ...
            "chatType": "direct",
            "origin": { "label": "Tony" },
            "worktree": { "id": "wt-1", "branch": "luckynemo/session-ux", "repoRoot": "C:\\src\\luckynemo" },
        ...
        Assert.Equal("luckynemo/session-ux", session.Worktree?.Branch);
    ...
    {
        // Mirrors the full NodeListNode schema from luckynemo/luckynemo
    ...
    public void Constructor_InitializesWithProvidedValues()
    {
        ...
        var field = typeof(LuckyNemoGatewayClient).BaseType?.GetField(
            "_gatewayUrl",
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
