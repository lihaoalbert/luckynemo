...
namespace LuckyNemo.Shared.Tests.Architecture;
...
public sealed class ArchitectureLedgerConsistencyTests
{
    ...
    private static string LocateArchitectureDoc()
    {
        ...
        var repoRoot = Environment.GetEnvironmentVariable("LUCKYNEMO_REPO_ROOT");
        ...
        throw new FileNotFoundException(
            ...
            "Set LUCKYNEMO_REPO_ROOT to the repository root when running in a linked worktree.");
    }
    ...
    private static string LocateTestsRoot()
    {
        ...
        for (var i = 0; i < 10 && dir is not null; i++)
        {
            ...
            if (Directory.Exists(Path.Combine(candidate, "LuckyNemo.Shared.Tests"))) return candidate;
            dir = Path.GetDirectoryName(dir);
        }
