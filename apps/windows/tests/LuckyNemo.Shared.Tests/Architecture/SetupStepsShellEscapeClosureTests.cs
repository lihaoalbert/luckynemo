...
/// <c>SetupSteps</c>' WSL quoting to <see cref="LuckyNemo.Shared.WslShellQuoting"/> and deleted
...
public sealed class SetupStepsShellEscapeClosureTests
{
    ...
    public void SetupSteps_DoesNotReintroduce_PrivateShellEscape()
    {
        ...
        Assert.False(
            ...
            "lines with LuckyNemo.Shared.WslShellQuoting (EscapePosixSingleQuoteInner for a value the " +
