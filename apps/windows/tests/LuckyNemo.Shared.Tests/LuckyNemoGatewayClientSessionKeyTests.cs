...
/// </summary>
public class LuckyNemoGatewayClientSessionKeyTests
{
    [Fact]
    public void ResolveEffectiveSessionKey_BothEmpty_Throws()
    {
        var ex = Assert.Throws<InvalidOperationException>(() =>
            LuckyNemoGatewayClient.ResolveEffectiveSessionKey(null, null, "chat.send"));
    ...
    public void ResolveEffectiveSessionKey_CallerEmpty_HandshakeEmpty_Throws()
    {
        Assert.Throws<InvalidOperationException>(() =>
            LuckyNemoGatewayClient.ResolveEffectiveSessionKey("", "", "chat.history"));
        Assert.Throws<InvalidOperationException>(() =>
            LuckyNemoGatewayClient.ResolveEffectiveSessionKey("   ", "   ", "chat.abort"));
    }

    [Fact]
    public void ResolveEffectiveSessionKey_HandshakeResolved_ReturnsCanonical()
    {
        var result = LuckyNemoGatewayClient.ResolveEffectiveSessionKey(
