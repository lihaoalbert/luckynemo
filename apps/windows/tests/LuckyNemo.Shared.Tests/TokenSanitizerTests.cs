...
public class TokenSanitizerTests
{
    ...
    public void Sanitize_RedactsBareGatewayHexTokenShape()
    {
        ...
        var sanitized = TokenSanitizer.Sanitize($"argv: luckynemo devices approve --token {token}");
    ...
    {
        var sanitized = TokenSanitizer.SanitizeLogMessage(@"Failed reading C:\Users\alice\AppData\Local\LuckyNemoTray\settings.json");
    ...
    [Theory]
    [InlineData(@"C:/Users/alice/AppData/Local/LuckyNemoTray/luckynemo-tray.log")]
    [InlineData(@"/mnt/c/Users/alice/AppData/Roaming/LuckyNemoTray/settings.json")]
    [InlineData(@"""C:\\Users\\alice\\AppData\\Local\\LuckyNemoTray\\luckynemo-tray.log""")]
    [InlineData(@"""C:\\\\Users\\\\alice\\\\AppData\\\\Local\\\\LuckyNemoTray\\\\luckynemo-tray.log""")]
    ...
    [Theory]
    [InlineData("/home/luckynemo/.luckynemo/sessions/abc123/session.jsonl")]
    [InlineData("/home/alice/.config/luckynemo/gateway-health.json")]
    public void SanitizeLogMessage_RedactsLinuxHomePathVariants(string path)
    {
        ...
        Assert.DoesNotContain("/home/luckynemo", sanitized, StringComparison.OrdinalIgnoreCase);
        Assert.DoesNotContain("/home/alice", sanitized, StringComparison.OrdinalIgnoreCase);
        Assert.DoesNotContain("luckynemo/.luckynemo", sanitized, StringComparison.OrdinalIgnoreCase);
    ...
    public void SanitizeLogMessage_RedactsDiagnosticSecretShapesBeforePersisting()
    {
        ...
        var input = string.Join(Environment.NewLine,
            ...
            "luckynemo connect --token shared-secret --setup-code setup-secret --password pass-secret");
