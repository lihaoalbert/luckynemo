...
/// luckynemo/luckynemo gateway-protocol schemas, plus request payload shaping.
/// </summary>
public class GatewayProtocolModelsTests
{
    ...
    {
        var result = LuckyNemoGatewayClient.ParseSessionCreateResult(Parse("""
        {
          "ok": true,
        ...
        var missing = LuckyNemoGatewayClient.ParseSessionCreateResult(Parse("""{"ok":true}"""));
    ...
    public void BuildSessionCreateParameters_LegacyParallelFallbackUnlinksParent()
    {
        ...
        var current = LuckyNemoGatewayClient.BuildSessionCreateParameters(request);
        ...
        var legacy = LuckyNemoGatewayClient.BuildSessionCreateParameters(
            request,
    ...
    {
        var result = LuckyNemoGatewayClient.ParseSessionCompactResult(Parse("""
        {
          "ok": true,
          "key": "agent:main:main",
          "compacted": true,
        ...
        var large = LuckyNemoGatewayClient.ParseSessionCompactResult(Parse("""
        {
          "ok": true,
          "compacted": true,
          "result": {
        ...
        var failed = LuckyNemoGatewayClient.ParseSessionCompactResult(Parse("""
    ...
    {
        var succeeded = LuckyNemoGatewayClient.ParseSessionResetResult(Parse("""
        {"ok":true,"key":"agent:main:main"}
        """));
        Assert.True(succeeded.Ok);
        Assert.Equal("agent:main:main", succeeded.Key);

        var failed = LuckyNemoGatewayClient.ParseSessionResetResult(Parse("""
    ...
    {
        var create = LuckyNemoGatewayClient.CreateSessionCreationTimeoutResult();
        ...
        var reset = LuckyNemoGatewayClient.CreateSessionResetTimeoutResult();
        Assert.False(reset.Ok);
        Assert.Contains("reset timed out", reset.Error);
        Assert.Contains("Refresh the session", reset.Error);

        var compact = LuckyNemoGatewayClient.CreateSessionCompactTimeoutResult();
    ...
    public void ParseCommandCatalog_ParsesCommandsArgsAndObjectChoices()
    {
        ...
        var catalog = LuckyNemoGatewayClient.ParseCommandCatalog(payload);
    ...
    {
        var catalog = LuckyNemoGatewayClient.ParseCommandCatalog(Parse("""
        {
          "commands": [
        ...
        var filtered = LuckyNemoGatewayClient.ApplyCommandQuery(catalog, new CommandCatalogQuery { Category = "session" });
    ...
    public void ParseSessionFileList_ParsesFilesAndBrowser()
    {
        ...
        var list = LuckyNemoGatewayClient.ParseSessionFileList(payload, "agent:main:main");
    ...
    public void ParseSessionFileContent_ParsesNestedFile()
    {
        ...
        var content = LuckyNemoGatewayClient.ParseSessionFileContent(payload, "agent:main:main", "notes.txt");
    ...
    public void ParseSessionFileContent_NoFileMeansMissing()
    {
        ...
        var content = LuckyNemoGatewayClient.ParseSessionFileContent(payload, "agent:main:main", "missing.txt");
    ...
    public void ParseCompactionCheckpointList_ParsesCheckpoints()
    {
        ...
        var list = LuckyNemoGatewayClient.ParseCompactionCheckpointList(payload, "agent:main:main");
    ...
    public void ParseCompactionCheckpointResult_ParsesSingleCheckpoint()
    {
        ...
        var result = LuckyNemoGatewayClient.ParseCompactionCheckpointResult(payload, "agent:main:main");
    ...
    public void ParseCompactionMutation_BranchExtractsSourceAndNewKey()
    {
        ...
        var result = LuckyNemoGatewayClient.ParseCompactionMutation(payload, "agent:main:main", "cp1");
