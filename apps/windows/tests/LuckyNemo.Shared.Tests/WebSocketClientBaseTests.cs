...
public class TestWebSocketClient : WebSocketClientBase
{
    ...
    public TestWebSocketClient(string gatewayUrl, string token, ILuckyNemoLogger? logger = null)
    ...
    public ILuckyNemoLogger TestLogger => _logger;
}
...
internal sealed class BlockingFirstConnectClient : WebSocketClientBase
{
    ...
    public BlockingFirstConnectClient(string gatewayUrl, string token, ILuckyNemoLogger? logger = null)
        : base(gatewayUrl, token, logger)
    {
    }
...
internal sealed class ReconnectBackoffRaceClient : WebSocketClientBase
{
    ...
    public ReconnectBackoffRaceClient(string gatewayUrl, string token, ILuckyNemoLogger? logger = null)
        : base(gatewayUrl, token, logger)
    {
    }
...
public class TestLogger : ILuckyNemoLogger
{
