...
public class NotificationCategorizerTests
{
    ...
    {
        var notification = new LuckyNemoNotification { Message = message };
    ...
    {
        var notification = new LuckyNemoNotification { Message = "URGENT: test" };
        Assert.Equal("urgent", _categorizer.Classify(notification).type);

        notification = new LuckyNemoNotification { Message = "urgent: test" };
        Assert.Equal("urgent", _categorizer.Classify(notification).type);
    }
    ...
    {
        var notification = new LuckyNemoNotification { Message = "test", Intent = intent };
    ...
    {
        var notification = new LuckyNemoNotification { Message = "test", Channel = channel };
        Assert.Equal(expectedType, _categorizer.Classify(notification).type);
    }
    ...
    public void UserRule_KeywordMatch_Categorizes()
    {
        ...
        var notification = new LuckyNemoNotification { Message = "New invoice received" };
    ...
    public void UserRule_RegexMatch_Categorizes()
    {
        ...
        var notification = new LuckyNemoNotification { Message = "PR #42 merged" };
    ...
    public void UserRule_InvalidRegex_IsSkipped()
    {
        ...
        var notification = new LuckyNemoNotification { Message = "Hello world" };
        Assert.Equal("info", _categorizer.Classify(notification, rules).type);
    }
    ...
    public void UserRule_TakesPriority_OverKeywords()
    {
        ...
        var notification = new LuckyNemoNotification { Message = "New items in your inbox" };
    ...
    public void UserRule_FirstMatchWins()
    {
        ...
        var notification = new LuckyNemoNotification { Message = "Daily report ready" };
        Assert.Equal("email", _categorizer.Classify(notification, rules).type);
    }
    ...
    {
        var notification = new LuckyNemoNotification { Message = "New email notification", Intent = "build" };
    ...
    {
        var notification = new LuckyNemoNotification { Message = "Check your email", Channel = "calendar" };
        var (_, type) = _categorizer.Classify(notification, preferStructuredCategories: false);
        Assert.Equal("email", type);
    }
    ...
    public void PreferStructuredCategories_False_UserRulesStillApply()
    {
        ...
        var notification = new LuckyNemoNotification { Message = "New invoice received", Intent = "urgent" };
    ...
    {
        var notification = new LuckyNemoNotification { Message = "Hello world", Intent = "build", Channel = "email" };
        var (_, type) = _categorizer.Classify(notification, preferStructuredCategories: false);
    ...
    {
        var notification = new LuckyNemoNotification { Message = "" };
    ...
    {
        var notification = new LuckyNemoNotification { Message = "urgent alert" };
