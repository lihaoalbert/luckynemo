...
public class SetupLoggerTests : IDisposable
{
    ...
    public void Redaction_RedactsPiiFromMessagesAndStructuredData()
    {
        ...
        logger.Info(
            @"Failed for C:\Users\alice\AppData\Roaming\LuckyNemoTray\settings.json from alice@example.com at 10.1.2.3 via alice@host:22",
            new
            {
                windowsPath = @"C:\Users\alice\AppData\Local\LuckyNemoTray\luckynemo-tray.log",
                forwardSlashPath = "C:/Users/alice/AppData/Local/LuckyNemoTray/luckynemo-tray.log",
                wslPath = "/mnt/c/Users/alice/AppData/Roaming/LuckyNemoTray/settings.json",
            ...
            logger.CommandCompleted(
                ...
                new CommandResult(
                    ...
                    """
                    {
                      "cli": {
                        "version": "2026.5.28",
                        "entrypoint": "/home/luckynemo/.luckynemo/tools/node-v22.22.0/lib/node_modules/luckynemo/dist/entry.js"
                      },
    ...
    public void CommandCompleted_WritesPiiRedactedJsonl()
    {
        ...
        using (var logger = new SetupLogger(path))
        {
            logger.CommandCompleted(
                ...
                new CommandResult(
                    0,
                    @"Using C:\Users\alice\AppData\Roaming\LuckyNemoTray and alice@example.com from 10.1.2.3",
                    "/mnt/c/Users/alice/.luckynemo failed against https://gateway.example.com:19001/full/path?token=secret",
                    TimeSpan.FromSeconds(1),
                    false),
                TimeSpan.FromSeconds(1));
        }
