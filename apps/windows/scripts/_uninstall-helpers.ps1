...
#
# Shared helper functions for LuckyNemo uninstall and cleanup scripts.
...
# distros like "LuckyNemoGateway-test" pass param validation and then strand
...
function Stop-LuckyNemoProcessByPid {
    <#
    .SYNOPSIS
