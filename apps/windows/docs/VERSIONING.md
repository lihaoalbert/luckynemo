# Versioning in LuckyNemo Windows Hub

## Source of truth

LuckyNemo uses GitVersion and git tags for application versioning. Product
...
`LuckyNemo.Shared.AppVersionInfo` reads `AssemblyInformationalVersionAttribute`
...
`scripts\Get-LuckyNemoVersion.ps1` uses the repository-local
...
.\scripts\Get-LuckyNemoVersion.ps1 -Variable MajorMinorPatch
```
