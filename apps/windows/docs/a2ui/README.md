...
- **Lit reference** from the upstream LuckyNemo A2UI renderer
  (`vendor/a2ui/renderers/lit/src/0.8`, web components rendered in a
  browser via the LuckyNemo canvas host).
- **Native WinUI** in this repo (`src/LuckyNemo.Tray.WinUI/A2UI/`).
...
| Area | Lit (LuckyNemo) | WinUI (this repo) | Spec |
| --- | --- | --- | --- |
