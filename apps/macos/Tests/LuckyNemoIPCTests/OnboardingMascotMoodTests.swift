...
struct OnboardingMascotMoodTests {
    private func mood(_ snapshot: OnboardingView.MascotMoodSnapshot) -> LuckyNemoMascotMood {
        OnboardingView.mascotMood(for: snapshot)
    }

    private func accessory(_ page: OnboardingView.MascotPage) -> LuckyNemoMascotAccessory {
