...
struct SettingsViewSmokeTests {
    @Test func `cron settings builds body`() {
        ...
        store.schedulerStorePath = "/tmp/luckynemo-cron-store.json"
    ...
    @Test func `LuckyNemo settings require configured inference`() {
    ...
    @Test func `LuckyNemo preserves same route and resets for gateway changes`() {
        let stateDir = URL(fileURLWithPath: "/Users/tester/.luckynemo")
