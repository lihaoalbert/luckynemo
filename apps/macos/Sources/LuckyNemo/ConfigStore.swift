...
enum ConfigStore {
    ...
    static func load() async -> [String: Any] {
        ...
        return LuckyNemoConfigFile.loadDict()
    }
        ...
        if await self.isRemoteMode() {
            ...
            if let override = overrides.saveLocal {
                ...
                do {
                    ...
                    guard LuckyNemoConfigFile.saveDict(
                        root,
...
extension Notification.Name {
    static let luckynemoConfigDidChange = Notification.Name("luckynemo.config.did-change")
}
