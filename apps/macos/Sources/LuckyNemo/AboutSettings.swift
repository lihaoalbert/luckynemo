...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            // Hero treatment from luckynemo.ai: coral silhouette glow at 10% of
            ...
            LuckyNemoMascotView(interactive: true)
                .frame(width: 160, height: 160)
                .shadow(
                    color: LuckyNemoMascotView.heroGlowColor(
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(icon: "globe", title: "Website", url: "https://luckynemo.ai")
                AboutLinkRow(icon: "book", title: "Docs", url: "https://docs.luckynemo.ai")
                AboutLinkRow(
                    icon: "chevron.left.slash.chevron.right",
                    title: "GitHub",
                    url: "https://github.com/luckynemo/luckynemo")
                AboutLinkRow(
            ...
            Text("© 2026 LuckyNemo Foundation — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
