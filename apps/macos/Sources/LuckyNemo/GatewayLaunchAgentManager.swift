...
enum GatewayLaunchAgentManager {
    ...
    private static let logger = Logger(subsystem: "ai.luckynemo", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".luckynemo/disable-launchagent"
    ...
    private static var generatedEnvironmentDirectoryURL: URL {
        LuckyNemoPaths.stateDirURL.appendingPathComponent("service-env", isDirectory: true)
    }
...
extension GatewayLaunchAgentManager {
    ...
    private static func gatewayPort(from service: [String: Any]) -> Int? {
        ...
        return self.validGatewayPort(environment?["LUCKYNEMO_GATEWAY_PORT"] as? String)
    }
