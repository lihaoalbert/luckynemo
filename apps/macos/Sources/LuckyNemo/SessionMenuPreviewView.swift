...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.luckynemo", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> LuckyNemoSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: LuckyNemoSessionPreviewEntry,
    ...
    private static func cache(payload: LuckyNemoSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: LuckyNemoChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [LuckyNemoKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [LuckyNemoKit.AnyCodable]) -> [LuckyNemoChatMessage] {
    ...
    private static func previewText(for message: LuckyNemoChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: LuckyNemoChatMessage) -> Bool {
    ...
    private static func toolNames(for message: LuckyNemoChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: LuckyNemoChatMessage) -> String? {
