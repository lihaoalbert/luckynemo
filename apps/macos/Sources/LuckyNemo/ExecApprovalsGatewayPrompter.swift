...
final class ExecApprovalsGatewayPrompter {
    ...
    private let logger = Logger(subsystem: "ai.luckynemo", category: "exec-approvals.gateway")
    ...
    private func handle(push: GatewayPush) async {
        ...
        guard evt.event == "exec.approval.requested" || evt.event == "luckynemo.approval.requested" else { return }
        ...
        do {
            ...
            if evt.event == "luckynemo.approval.requested" {
