...
extension OnboardingView {
    /// The inference-first flow has no full-page chat; LuckyNemo opens in its own sheet.
    ...
    func resetGatewayBoundAIState() {
        ...
        aiSetup.resetForGatewayChange(clearPendingHandoff: false)
        memoryImport.reset()
        // LuckyNemo sessions belong to one Gateway. Dismiss and replace the chat so
