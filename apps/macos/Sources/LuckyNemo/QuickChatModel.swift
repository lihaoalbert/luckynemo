...
final class QuickChatModel {
    private struct RetryIdentity {
        ...
        let sessionKey: String
        let agentID: String?
        let attachments: [LuckyNemoChatAttachmentPayload]
    ...
    typealias SendProvider = @MainActor (
        ...
        String,
        String,
        [LuckyNemoChatAttachmentPayload]) async throws -> String
    ...
    var connectionStatusMessage: String? {
        ...
        case .paused: "LuckyNemo is paused"
