...
enum LuckyNemoConfigFile {
    private static let logger = Logger(subsystem: "ai.luckynemo", category: "config")
    ...
    static func url() -> URL {
        LuckyNemoPaths.configURL
    }

    static func stateDirURL() -> URL {
        LuckyNemoPaths.stateDirURL
    }
...
extension LuckyNemoConfigFile {
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-luckynemo-config-file",
            "event": "config.write",
