...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.luckynemo", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other LuckyNemo windows, but below the system’s pop-up menus.
