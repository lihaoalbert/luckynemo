...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: LuckyNemoProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": LuckyNemoProtocol.AnyCodable("start"),
                "name": LuckyNemoProtocol.AnyCodable("bash"),
            ],
            summary: nil)
