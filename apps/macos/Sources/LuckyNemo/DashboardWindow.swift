...
let dashboardWindowLogger = Logger(subsystem: "ai.luckynemo", category: "DashboardWindow")
...
enum DashboardWindowLayout {
    ...
    static let linkBrowserWidthDefaultsKey = "LuckyNemoDashboardLinkBrowserWidth"
    static let windowFrameAutosaveName = "LuckyNemoDashboardWindow"
...
enum DashboardNativeCommand: String {
    case newSession = "luckynemo:native-new-session"
    case commandPalette = "luckynemo:native-toggle-search"
    ...
    var legacyFallbackEventName: String? {
        switch self {
        case .newSession: nil
        case .commandPalette: "luckynemo:native-open-search"
        }
    }
}
