...
enum WideAreaGatewayDiscovery {
        ...
        context: DiscoveryContext = .live) -> [WideAreaGatewayBeacon]
    {
        ...
        for raw in ptrLines {
            ...
            let suffix = "._luckynemo-gw._tcp.\(domainTrimmed)"
    ...
    {
        guard let domain = LuckyNemoBonjour.wideAreaGatewayServiceDomain else { return nil }
        let domainTrimmed = domain.trimmingCharacters(in: CharacterSet(charactersIn: "."))
        let probeName = "_luckynemo-gw._tcp.\(domainTrimmed)"
