...
struct ConnectOptions {
    ...
    var clientId: String = "luckynemo-macos"
...
func runConnect(_ args: [String]) async {
    ...
    if opts.help {
        ...
        Options:
          ...
          --json             Emit JSON
          --client-id <id>   Override client id (default: luckynemo-macos)
    ...
    do {
        ...
        let displayName = opts.displayName ?? Host.current().localizedName ?? "LuckyNemo macOS Debug CLI"
...
private func printConnectOutput(_ output: ConnectOutput, json: Bool) {
    ...
    print("LuckyNemo macOS Gateway Connect")
...
func gatewayURLDeviceAuthOwner(_ url: URL, mode: String) -> String {
    ...
    return "luckynemo-mac-cli:route:\(fingerprint)"
}
