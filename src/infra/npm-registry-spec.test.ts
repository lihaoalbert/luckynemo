...
describe("npm registry spec validation", () => {
  it.each([
    ...
    "@luckynemo/voice-call@1.2.3",
    "@luckynemo/voice-call@1.2.3-beta.4",
    "@luckynemo/voice-call@latest",
    "@luckynemo/voice-call@beta",
  ])("accepts %s", (spec) => {
  ...
  it.each([
    {
      spec: "@luckynemo/voice-call@^1.2.3",
...
describe("npm registry spec parsing helpers", () => {
  it.each([
    ...
    {
      spec: "@luckynemo/voice-call@2026.5.3-1",
      expected: {
        name: "@luckynemo/voice-call",
        raw: "@luckynemo/voice-call@2026.5.3-1",
        selector: "2026.5.3-1",
    ...
    {
      spec: "@luckynemo/voice-call@1.2.3-beta.1",
      expected: {
        name: "@luckynemo/voice-call",
        raw: "@luckynemo/voice-call@1.2.3-beta.1",
  ...
  it.each([
    { spec: "@luckynemo/voice-call", expected: true },
    { spec: "@luckynemo/voice-call@1.2.3", expected: true },
    { spec: "@other/voice-call", expected: false },
    { spec: "voice-call", expected: false },
    { spec: "npm:@luckynemo/voice-call", expected: false },
...
describe("npm prerelease resolution policy", () => {
  it.each([
    ...
    {
      spec: "@luckynemo/voice-call@latest",
  ...
  it.each([
    {
      spec: "@luckynemo/voice-call",
      resolvedVersion: "1.2.3-beta.1",
      expected: `Use "@luckynemo/voice-call@beta"`,
    },
    {
      spec: "@luckynemo/voice-call@beta",
      resolvedVersion: "1.2.3-rc.1",
