...
import { formatErrorMessage as formatSharedErrorMessage } from "@luckynemo/normalization-core/error-coercion";
...
export {
  ...
  toErrorObject,
} from "@luckynemo/normalization-core/error-coercion";
