...
describe("resolveNpmInstallRecordSpec", () => {
  it("uses an exact resolved registry spec when managed installs request pinning", () => {
    expect(
      resolveNpmInstallRecordSpec({
        requestedSpec: "@luckynemo/codex",
        resolution: {
          name: "@luckynemo/codex",
          version: "2026.5.30-beta.1",
          resolvedSpec: "@luckynemo/codex@2026.5.30-beta.1",
        },
        pinResolvedRegistrySpec: true,
      }),
    ).toBe("@luckynemo/codex@2026.5.30-beta.1");
  });
    ...
    expect(
      resolveNpmInstallRecordSpec({
        ...
        resolution: {
          name: "@luckynemo/codex",
          version: "2026.5.30-beta.1",
          resolvedSpec: "@luckynemo/codex@beta",
        },
        pinResolvedRegistrySpec: true,
      }),
    ).toBe("@luckynemo/codex");
