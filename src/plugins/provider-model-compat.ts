...
import { resolveUnsupportedToolSchemaKeywords } from "@luckynemo/ai/internal/openai";
...
// Tool-schema compat predicates moved into @luckynemo/ai (agent-tools-parameter-schema);
