...
function vllmPluginWithPackageInstall(): InstalledPluginIndexRecord {
  return {
    ...
    compat: [],
    packageName: "@luckynemo/vllm",
    packageInstall: {
      npm: {
        spec: "@luckynemo/vllm-fork@1.0.0",
        packageName: "@luckynemo/vllm-fork",
        selector: "1.0.0",
      ...
      plugins: [
        {
          ...
          compat: [],
          packageName: "@luckynemo/openai",
          packageInstall: {
            defaultChoice: "npm",
            npm: {
              spec: "@luckynemo/openai@1.2.3",
              packageName: "@luckynemo/openai",
              selector: "1.2.3",
              selectorKind: "exact-version",
              exactVersion: true,
    ...
    expect(resolveProviderInstallCatalogEntries()).toEqual([
      {
        ...
        origin: "bundled",
        install: {
          npmSpec: "@luckynemo/openai@1.2.3",
      ...
      registrySnapshot({
        installRecords: {
          vllm: {
            source: "npm",
            spec: "@luckynemo/vllm",
            resolvedSpec: "@luckynemo/vllm@2.0.0",
  ...
  it("surfaces provider-index install metadata when the provider plugin is not installed", () => {
    loadOpenClawProviderIndex.mockReturnValue({
      ...
      providers: {
        moonshot: {
          ...
          plugin: {
            id: "moonshot",
            package: "@luckynemo/plugin-moonshot",
            install: {
              npmSpec: "@luckynemo/plugin-moonshot@1.2.3",
              defaultChoice: "npm",
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "npm",
        npm: {
          spec: "@luckynemo/plugin-moonshot@1.2.3",
          packageName: "@luckynemo/plugin-moonshot",
          selector: "1.2.3",
          selectorKind: "exact-version",
          exactVersion: true,
          expectedIntegrity: "sha512-moonshot",
    ...
    listOfficialExternalProviderCatalogEntries.mockReturnValue([
      {
        ...
        openclaw: {
          ...
          install: {
            npmSpec: "@luckynemo/qwen-provider",
            defaultChoice: "npm",
          },
        },
      },
  ...
  it("surfaces provider-index ClawHub install metadata as the preferred source", () => {
        ...
        moonshot: {
          ...
          plugin: {
            ...
            install: {
              ...
              npmSpec: "@luckynemo/plugin-moonshot@2026.5.2",
              defaultChoice: "clawhub",
              expectedIntegrity: "sha512-moonshot",
            },
          },
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@luckynemo/plugin-moonshot@2026.5.2",
          packageName: "@luckynemo/plugin-moonshot",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
  ...
  it("keeps missing provider-index entries visible when only some provider plugins are installed", () => {
    ...
    loadOpenClawProviderIndex.mockReturnValue({
      ...
      providers: {
        groq: {
          ...
          plugin: {
            id: "groq",
            package: "@luckynemo/plugin-groq",
            install: {
              npmSpec: "@luckynemo/plugin-groq@1.0.0",
              defaultChoice: "npm",
            },
          },
          authChoices: [
        ...
        vllm: {
          ...
          plugin: {
            id: "vllm",
            package: "@luckynemo/plugin-vllm",
            install: {
              clawhubSpec: "clawhub:openclaw/vllm@2026.5.2",
              npmSpec: "@luckynemo/plugin-vllm@2026.5.2",
              defaultChoice: "clawhub",
            },
          },
          authChoices: [
    ...
    expect(resolveProviderInstallCatalogEntry("vllm-server")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@luckynemo/plugin-vllm@2026.5.2",
          packageName: "@luckynemo/plugin-vllm",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
