...
const DEFAULT_TAGLINE = "All your chats, one 徐大恩.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little fin-elver is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just grew fins—type something and let the bot draft the busywork.",
  ...
  "Gateway online—please keep hands, feet, and flippers inside the shell at all times.",
  ...
  "I'm not saying your workflow is chaotic... I'm just bringing a linter and a life vest.",
  ...
  "I keep secrets like a reef... unless you print them in debug logs again.",
  "Automation with fins: minimal fuss, maximal draft.",
  ...
  "Fins up, commit in—let's ship something mildly responsible.",
  "I'll butter your workflow like a sushi roll: messy, delicious, effective.",
  "Shell yeah—I'm here to draft the toil and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The only fish in your contacts you actually want to hear from. 🐠",
  ...
  "Built by mascots, for humans. Don't question the hierarchy.",
  ...
  "The only open-source project where the mascot outswims the competition.",
  ...
  "Half butler, half debugger, full fish.",
  ...
  "Runs on a Raspberry Pi. Dreams of a tank at the aquarium.",
  "The mascot in your shell. 🐠",
  "Alexa, but with taste.",
  "I'm not AI-powered, I'm AI-possessed. Big difference.",
  "You had me at 'luckynemo gateway start.'",
  "Fresh shell, same fins—moulting is just semver for fish.",
  "Frequently forked, never outgrown the tank.",
  "Upstream is a perfectly valid direction of progress—trust me, I'm a fish.",
  "I contain multitudes. Mostly subagents.",
  "Technically a daemon, spiritually a familiar.",
  "If found wandering, please return to ~/.luckynemo.",
  ...
  "LuckyNemo Support will never DM you first. I, on the other hand, absolutely will.",
  ...
  "The artist formerly known as LuckyBot.",
  ...
  "Primary model down, fallback engaged: the show must swim on.",
