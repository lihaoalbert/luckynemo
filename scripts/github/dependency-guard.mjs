...
export function renderAuthorizedDependencyComment(override) {
  const lines = [
    ...
    "",
    "This PR includes dependency graph changes. A repository admin or member of `@luckynemo/openclaw-secops` authorized this exact head SHA with `/allow-dependencies-change`.",
    "",
...
export function renderTrustedDependencyComment({ actor, headSha }) {
  return [
    ...
    "",
    "This PR includes dependency graph changes. The dependency guard is informational because the PR author is a repository admin or a member of `@luckynemo/openclaw-secops`.",
    "",
...
export function renderBlockedDependencyComment({
  ...
  return [
    ...
    ...removalSteps,
    "",
    "If this PR intentionally needs a dependency graph change, ask a repository admin or member of `@luckynemo/openclaw-secops` to comment:",
    "",
    "```text",
