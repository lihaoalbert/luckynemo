...
// macOS, so the iOS coverage owner lives in LuckyNemoChatUI.
const IOS_SCAN_ROOTS = ["apps/ios/Sources", "apps/shared/LuckyNemoKit/Sources"];
const IOS_SENTINEL_FILE =
  "apps/shared/LuckyNemoKit/Sources/LuckyNemoChatUI/ChatGatewayPayloadCodec.swift";
