// Minimal @luckynemo/ai consumer: one isolated runtime, built-in providers,
...
import { createLlmRuntime } from "@luckynemo/ai";
...
const prompt =
  ...
  "Reply with one short sentence: what is @luckynemo/ai?";
